var It=Object.defineProperty;var _e=e=>{throw TypeError(e)};var Tt=(e,t,a)=>t in e?It(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var p=(e,t,a)=>Tt(e,typeof t!="symbol"?t+"":t,a),Oe=(e,t,a)=>t.has(e)||_e("Cannot "+a);var c=(e,t,a)=>(Oe(e,t,"read from private field"),a?a.call(e):t.get(e)),m=(e,t,a)=>t.has(e)?_e("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),h=(e,t,a,r)=>(Oe(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),b=(e,t,a)=>(Oe(e,t,"access private method"),a);var qe=(e,t,a,r)=>({set _(n){h(e,t,n,a)},get _(){return c(e,t,r)}});var Ye=(e,t,a)=>(r,n)=>{let o=-1;return i(0);async function i(d){if(d<=o)throw new Error("next() called multiple times");o=d;let s,l=!1,u;if(e[d]?(u=e[d][0][0],r.req.routeIndex=d):u=d===e.length&&n||void 0,u)try{s=await u(r,()=>i(d+1))}catch(g){if(g instanceof Error&&t)r.error=g,s=await t(g,r),l=!0;else throw g}else r.finalized===!1&&a&&(s=await a(r));return s&&(r.finalized===!1||l)&&(r.res=s),r}},St=Symbol(),Ct=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,o=(e instanceof lt?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?Et(e,{all:a,dot:r}):{}};async function Et(e,t){const a=await e.formData();return a?Rt(a,t):{}}function Rt(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?kt(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(At(a,r,n),delete a[r])}),a}var kt=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},At=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((o,i)=>{i===n.length-1?r[o]=a:((!r[o]||typeof r[o]!="object"||Array.isArray(r[o])||r[o]instanceof File)&&(r[o]=Object.create(null)),r=r[o])})},rt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Lt=e=>{const{groups:t,path:a}=Bt(e),r=rt(a);return Ht(r,t)},Bt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},Ht=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},Ce={},Dt=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return Ce[r]||(a[2]?Ce[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Ce[r]=[e,a[1],!0]),Ce[r]}return null},Ne=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Pt=e=>Ne(e,decodeURI),nt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const o=t.indexOf("?",r),i=t.slice(a,o===-1?void 0:o);return Pt(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(n===63)break}return t.slice(a,r)},Ot=e=>{const t=nt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},re=(e,t,...a)=>(a.length&&(t=re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ot=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const o=n.replace("?","");r+="/"+o,a.push(r)}else r+="/"+n}),a.filter((n,o,i)=>i.indexOf(n)===o)},je=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ne(e,st):e):e,it=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const d=e.charCodeAt(i+t.length+1);if(d===61){const s=i+t.length+2,l=e.indexOf("&",s);return je(e.slice(s,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const i=e.indexOf("&",o+1);let d=e.indexOf("=",o);d>i&&i!==-1&&(d=-1);let s=e.slice(o+1,d===-1?i===-1?void 0:i:d);if(r&&(s=je(s)),o=i,s==="")continue;let l;d===-1?l="":(l=e.slice(d+1,i===-1?void 0:i),r&&(l=je(l))),a?(n[s]&&Array.isArray(n[s])||(n[s]=[]),n[s].push(l)):n[s]??(n[s]=l)}return t?n[t]:n},jt=it,Ut=(e,t)=>it(e,t,!0),st=decodeURIComponent,We=e=>Ne(e,st),ie,A,N,ct,dt,ze,$,Xe,lt=(Xe=class{constructor(e,t="/",a=[[]]){m(this,N);p(this,"raw");m(this,ie);m(this,A);p(this,"routeIndex",0);p(this,"path");p(this,"bodyCache",{});m(this,$,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,h(this,A,a),h(this,ie,{})}param(e){return e?b(this,N,ct).call(this,e):b(this,N,dt).call(this)}query(e){return jt(this.url,e)}queries(e){return Ut(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ct(this,e))}json(){return c(this,$).call(this,"text").then(e=>JSON.parse(e))}text(){return c(this,$).call(this,"text")}arrayBuffer(){return c(this,$).call(this,"arrayBuffer")}blob(){return c(this,$).call(this,"blob")}formData(){return c(this,$).call(this,"formData")}addValidatedData(e,t){c(this,ie)[e]=t}valid(e){return c(this,ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[St](){return c(this,A)}get matchedRoutes(){return c(this,A)[0].map(([[,e]])=>e)}get routePath(){return c(this,A)[0].map(([[,e]])=>e)[this.routeIndex].path}},ie=new WeakMap,A=new WeakMap,N=new WeakSet,ct=function(e){const t=c(this,A)[0][this.routeIndex][1][e],a=b(this,N,ze).call(this,t);return a&&/\%/.test(a)?We(a):a},dt=function(){const e={},t=Object.keys(c(this,A)[0][this.routeIndex][1]);for(const a of t){const r=b(this,N,ze).call(this,c(this,A)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?We(r):r)}return e},ze=function(e){return c(this,A)[1]?c(this,A)[1][e]:e},$=new WeakMap,Xe),Ft={Stringify:1},ut=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(n?n[0]+=e:n=[e],Promise.all(o.map(d=>d({phase:t,buffer:n,context:r}))).then(d=>Promise.all(d.filter(Boolean).map(s=>ut(s,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},zt="text/plain; charset=UTF-8",Ue=(e,t)=>({"Content-Type":e,...t}),ye,ve,j,se,U,R,we,le,ce,J,Ie,Te,G,ne,Ve,Nt=(Ve=class{constructor(e,t){m(this,G);m(this,ye);m(this,ve);p(this,"env",{});m(this,j);p(this,"finalized",!1);p(this,"error");m(this,se);m(this,U);m(this,R);m(this,we);m(this,le);m(this,ce);m(this,J);m(this,Ie);m(this,Te);p(this,"render",(...e)=>(c(this,le)??h(this,le,t=>this.html(t)),c(this,le).call(this,...e)));p(this,"setLayout",e=>h(this,we,e));p(this,"getLayout",()=>c(this,we));p(this,"setRenderer",e=>{h(this,le,e)});p(this,"header",(e,t,a)=>{this.finalized&&h(this,R,new Response(c(this,R).body,c(this,R)));const r=c(this,R)?c(this,R).headers:c(this,J)??h(this,J,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});p(this,"status",e=>{h(this,se,e)});p(this,"set",(e,t)=>{c(this,j)??h(this,j,new Map),c(this,j).set(e,t)});p(this,"get",e=>c(this,j)?c(this,j).get(e):void 0);p(this,"newResponse",(...e)=>b(this,G,ne).call(this,...e));p(this,"body",(e,t,a)=>b(this,G,ne).call(this,e,t,a));p(this,"text",(e,t,a)=>!c(this,J)&&!c(this,se)&&!t&&!a&&!this.finalized?new Response(e):b(this,G,ne).call(this,e,t,Ue(zt,a)));p(this,"json",(e,t,a)=>b(this,G,ne).call(this,JSON.stringify(e),t,Ue("application/json",a)));p(this,"html",(e,t,a)=>{const r=n=>b(this,G,ne).call(this,n,t,Ue("text/html; charset=UTF-8",a));return typeof e=="object"?ut(e,Ft.Stringify,!1,{}).then(r):r(e)});p(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});p(this,"notFound",()=>(c(this,ce)??h(this,ce,()=>new Response),c(this,ce).call(this,this)));h(this,ye,e),t&&(h(this,U,t.executionCtx),this.env=t.env,h(this,ce,t.notFoundHandler),h(this,Te,t.path),h(this,Ie,t.matchResult))}get req(){return c(this,ve)??h(this,ve,new lt(c(this,ye),c(this,Te),c(this,Ie))),c(this,ve)}get event(){if(c(this,U)&&"respondWith"in c(this,U))return c(this,U);throw Error("This context has no FetchEvent")}get executionCtx(){if(c(this,U))return c(this,U);throw Error("This context has no ExecutionContext")}get res(){return c(this,R)||h(this,R,new Response(null,{headers:c(this,J)??h(this,J,new Headers)}))}set res(e){if(c(this,R)&&e){e=new Response(e.body,e);for(const[t,a]of c(this,R).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=c(this,R).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}h(this,R,e),this.finalized=!0}get var(){return c(this,j)?Object.fromEntries(c(this,j)):{}}},ye=new WeakMap,ve=new WeakMap,j=new WeakMap,se=new WeakMap,U=new WeakMap,R=new WeakMap,we=new WeakMap,le=new WeakMap,ce=new WeakMap,J=new WeakMap,Ie=new WeakMap,Te=new WeakMap,G=new WeakSet,ne=function(e,t,a){const r=c(this,R)?new Headers(c(this,R).headers):c(this,J)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,d]of o)i.toLowerCase()==="set-cookie"?r.append(i,d):r.set(i,d)}if(a)for(const[o,i]of Object.entries(a))if(typeof i=="string")r.set(o,i);else{r.delete(o);for(const d of i)r.append(o,d)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??c(this,se);return new Response(e,{status:n,headers:r})},Ve),w="ALL",Mt="all",$t=["get","post","put","delete","options","patch"],gt="Can not add a route since the matcher is already built.",ht=class extends Error{},Gt="__COMPOSED_HANDLER",_t=e=>e.text("404 Not Found",404),Ze=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},H,I,ft,D,Z,Ee,Re,de,qt=(de=class{constructor(t={}){m(this,I);p(this,"get");p(this,"post");p(this,"put");p(this,"delete");p(this,"options");p(this,"patch");p(this,"all");p(this,"on");p(this,"use");p(this,"router");p(this,"getPath");p(this,"_basePath","/");m(this,H,"/");p(this,"routes",[]);m(this,D,_t);p(this,"errorHandler",Ze);p(this,"onError",t=>(this.errorHandler=t,this));p(this,"notFound",t=>(h(this,D,t),this));p(this,"fetch",(t,...a)=>b(this,I,Re).call(this,t,a[1],a[0],t.method));p(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${re("/",t)}`,a),r,n)));p(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,I,Re).call(this,t.request,t,void 0,t.request.method))})});[...$t,Mt].forEach(o=>{this[o]=(i,...d)=>(typeof i=="string"?h(this,H,i):b(this,I,Z).call(this,o,c(this,H),i),d.forEach(s=>{b(this,I,Z).call(this,o,c(this,H),s)}),this)}),this.on=(o,i,...d)=>{for(const s of[i].flat()){h(this,H,s);for(const l of[o].flat())d.map(u=>{b(this,I,Z).call(this,l.toUpperCase(),c(this,H),u)})}return this},this.use=(o,...i)=>(typeof o=="string"?h(this,H,o):(h(this,H,"*"),i.unshift(o)),i.forEach(d=>{b(this,I,Z).call(this,w,c(this,H),d)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??nt:Ot}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let o;a.errorHandler===Ze?o=n.handler:(o=async(d,s)=>(await Ye([],a.errorHandler)(d,()=>n.handler(d,s))).res,o[Gt]=n.handler),b(i=r,I,Z).call(i,n.method,n.path,o)}),this}basePath(t){const a=b(this,I,ft).call(this);return a._basePath=re(this._basePath,t),a}mount(t,a,r){let n,o;r&&(typeof r=="function"?o=r:(o=r.optionHandler,r.replaceRequest===!1?n=s=>s:n=r.replaceRequest));const i=o?s=>{const l=o(s);return Array.isArray(l)?l:[l]}:s=>{let l;try{l=s.executionCtx}catch{}return[s.env,l]};n||(n=(()=>{const s=re(this._basePath,t),l=s==="/"?0:s.length;return u=>{const g=new URL(u.url);return g.pathname=g.pathname.slice(l)||"/",new Request(g,u)}})());const d=async(s,l)=>{const u=await a(n(s.req.raw),...i(s));if(u)return u;await l()};return b(this,I,Z).call(this,w,re(t,"*"),d),this}},H=new WeakMap,I=new WeakSet,ft=function(){const t=new de({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,h(t,D,c(this,D)),t.routes=this.routes,t},D=new WeakMap,Z=function(t,a,r){t=t.toUpperCase(),a=re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},Ee=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},Re=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,I,Re).call(this,t,a,r,"GET")))();const o=this.getPath(t,{env:r}),i=this.router.match(n,o),d=new Nt(t,{path:o,matchResult:i,env:r,executionCtx:a,notFoundHandler:c(this,D)});if(i[0].length===1){let l;try{l=i[0][0][0][0](d,async()=>{d.res=await c(this,D).call(this,d)})}catch(u){return b(this,I,Ee).call(this,u,d)}return l instanceof Promise?l.then(u=>u||(d.finalized?d.res:c(this,D).call(this,d))).catch(u=>b(this,I,Ee).call(this,u,d)):l??c(this,D).call(this,d)}const s=Ye(i[0],this.errorHandler,c(this,D));return(async()=>{try{const l=await s(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return b(this,I,Ee).call(this,l,d)}})()},de),pt=[];function Yt(e,t){const a=this.buildAllMatchers(),r=(n,o)=>{const i=a[n]||a[w],d=i[2][o];if(d)return d;const s=o.match(i[0]);if(!s)return[[],pt];const l=s.indexOf("",1);return[i[1][l],s]};return this.match=r,r(e,t)}var Ae="[^/]+",be=".*",xe="(?:|/.*)",oe=Symbol(),Wt=new Set(".\\+*[^]$()");function Zt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===be||e===xe?1:t===be||t===xe?-1:e===Ae?1:t===Ae?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var X,V,P,te,Kt=(te=class{constructor(){m(this,X);m(this,V);m(this,P,Object.create(null))}insert(t,a,r,n,o){if(t.length===0){if(c(this,X)!==void 0)throw oe;if(o)return;h(this,X,a);return}const[i,...d]=t,s=i==="*"?d.length===0?["","",be]:["","",Ae]:i==="/*"?["","",xe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(s){const u=s[1];let g=s[2]||Ae;if(u&&s[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw oe;if(l=c(this,P)[g],!l){if(Object.keys(c(this,P)).some(f=>f!==be&&f!==xe))throw oe;if(o)return;l=c(this,P)[g]=new te,u!==""&&h(l,V,n.varIndex++)}!o&&u!==""&&r.push([u,c(l,V)])}else if(l=c(this,P)[i],!l){if(Object.keys(c(this,P)).some(u=>u.length>1&&u!==be&&u!==xe))throw oe;if(o)return;l=c(this,P)[i]=new te}l.insert(d,a,r,n,o)}buildRegExpStr(){const a=Object.keys(c(this,P)).sort(Zt).map(r=>{const n=c(this,P)[r];return(typeof c(n,V)=="number"?`(${r})@${c(n,V)}`:Wt.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof c(this,X)=="number"&&a.unshift(`#${c(this,X)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},X=new WeakMap,V=new WeakMap,P=new WeakMap,te),Le,Se,Qe,Jt=(Qe=class{constructor(){m(this,Le,{varIndex:0});m(this,Se,new Kt)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let d=!1;if(e=e.replace(/\{[^}]+\}/g,s=>{const l=`@\\${i}`;return n[i]=[l,s],i++,d=!0,l}),!d)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[d]=n[i];for(let s=o.length-1;s>=0;s--)if(o[s].indexOf(d)!==-1){o[s]=o[s].replace(d,n[i][1]);break}}return c(this,Se).insert(o,t,r,c(this,Le),a),r}buildRegExp(){let e=c(this,Se).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,i)=>o!==void 0?(a[++t]=Number(o),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},Le=new WeakMap,Se=new WeakMap,Qe),Xt=[/^$/,[],Object.create(null)],ke=Object.create(null);function mt(e){return ke[e]??(ke[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Vt(){ke=Object.create(null)}function Qt(e){var l;const t=new Jt,a=[];if(e.length===0)return Xt;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,g],[f,x])=>u?1:f?-1:g.length-x.length),n=Object.create(null);for(let u=0,g=-1,f=r.length;u<f;u++){const[x,T,L]=r[u];x?n[T]=[L.map(([v])=>[v,Object.create(null)]),pt]:g++;let y;try{y=t.insert(T,g,x)}catch(v){throw v===oe?new ht(T):v}x||(a[g]=L.map(([v,B])=>{const he=Object.create(null);for(B-=1;B>=0;B--){const[fe,k]=y[B];he[fe]=k}return[v,he]}))}const[o,i,d]=t.buildRegExp();for(let u=0,g=a.length;u<g;u++)for(let f=0,x=a[u].length;f<x;f++){const T=(l=a[u][f])==null?void 0:l[1];if(!T)continue;const L=Object.keys(T);for(let y=0,v=L.length;y<v;y++)T[L[y]]=d[T[L[y]]]}const s=[];for(const u in i)s[u]=a[i[u]];return[o,s,n]}function ae(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(mt(a).test(t))return[...e[a]]}}var _,q,Be,bt,et,ea=(et=class{constructor(){m(this,Be);p(this,"name","RegExpRouter");m(this,_);m(this,q);p(this,"match",Yt);h(this,_,{[w]:Object.create(null)}),h(this,q,{[w]:Object.create(null)})}add(e,t,a){var d;const r=c(this,_),n=c(this,q);if(!r||!n)throw new Error(gt);r[e]||[r,n].forEach(s=>{s[e]=Object.create(null),Object.keys(s[w]).forEach(l=>{s[e][l]=[...s[w][l]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const s=mt(t);e===w?Object.keys(r).forEach(l=>{var u;(u=r[l])[t]||(u[t]=ae(r[l],t)||ae(r[w],t)||[])}):(d=r[e])[t]||(d[t]=ae(r[e],t)||ae(r[w],t)||[]),Object.keys(r).forEach(l=>{(e===w||e===l)&&Object.keys(r[l]).forEach(u=>{s.test(u)&&r[l][u].push([a,o])})}),Object.keys(n).forEach(l=>{(e===w||e===l)&&Object.keys(n[l]).forEach(u=>s.test(u)&&n[l][u].push([a,o]))});return}const i=ot(t)||[t];for(let s=0,l=i.length;s<l;s++){const u=i[s];Object.keys(n).forEach(g=>{var f;(e===w||e===g)&&((f=n[g])[u]||(f[u]=[...ae(r[g],u)||ae(r[w],u)||[]]),n[g][u].push([a,o-l+s+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(c(this,q)).concat(Object.keys(c(this,_))).forEach(t=>{e[t]||(e[t]=b(this,Be,bt).call(this,t))}),h(this,_,h(this,q,void 0)),Vt(),e}},_=new WeakMap,q=new WeakMap,Be=new WeakSet,bt=function(e){const t=[];let a=e===w;return[c(this,_),c(this,q)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(o=>[o,r[e][o]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==w&&t.push(...Object.keys(r[w]).map(o=>[o,r[w][o]]))}),a?Qt(t):null},et),Y,F,tt,ta=(tt=class{constructor(e){p(this,"name","SmartRouter");m(this,Y,[]);m(this,F,[]);h(this,Y,e.routers)}add(e,t,a){if(!c(this,F))throw new Error(gt);c(this,F).push([e,t,a])}match(e,t){if(!c(this,F))throw new Error("Fatal error");const a=c(this,Y),r=c(this,F),n=a.length;let o=0,i;for(;o<n;o++){const d=a[o];try{for(let s=0,l=r.length;s<l;s++)d.add(...r[s]);i=d.match(e,t)}catch(s){if(s instanceof ht)continue;throw s}this.match=d.match.bind(d),h(this,Y,[d]),h(this,F,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(c(this,F)||c(this,Y).length!==1)throw new Error("No active router has been determined yet.");return c(this,Y)[0]}},Y=new WeakMap,F=new WeakMap,tt),me=Object.create(null),W,E,Q,ue,S,z,K,ge,aa=(ge=class{constructor(t,a,r){m(this,z);m(this,W);m(this,E);m(this,Q);m(this,ue,0);m(this,S,me);if(h(this,E,r||Object.create(null)),h(this,W,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},h(this,W,[n])}h(this,Q,[])}insert(t,a,r){h(this,ue,++qe(this,ue)._);let n=this;const o=Lt(a),i=[];for(let d=0,s=o.length;d<s;d++){const l=o[d],u=o[d+1],g=Dt(l,u),f=Array.isArray(g)?g[0]:l;if(f in c(n,E)){n=c(n,E)[f],g&&i.push(g[1]);continue}c(n,E)[f]=new ge,g&&(c(n,Q).push(g),i.push(g[1])),n=c(n,E)[f]}return c(n,W).push({[t]:{handler:r,possibleKeys:i.filter((d,s,l)=>l.indexOf(d)===s),score:c(this,ue)}}),n}search(t,a){var s;const r=[];h(this,S,me);let o=[this];const i=rt(a),d=[];for(let l=0,u=i.length;l<u;l++){const g=i[l],f=l===u-1,x=[];for(let T=0,L=o.length;T<L;T++){const y=o[T],v=c(y,E)[g];v&&(h(v,S,c(y,S)),f?(c(v,E)["*"]&&r.push(...b(this,z,K).call(this,c(v,E)["*"],t,c(y,S))),r.push(...b(this,z,K).call(this,v,t,c(y,S)))):x.push(v));for(let B=0,he=c(y,Q).length;B<he;B++){const fe=c(y,Q)[B],k=c(y,S)===me?{}:{...c(y,S)};if(fe==="*"){const M=c(y,E)["*"];M&&(r.push(...b(this,z,K).call(this,M,t,c(y,S))),h(M,S,k),x.push(M));continue}const[De,Ge,pe]=fe;if(!g&&!(pe instanceof RegExp))continue;const O=c(y,E)[De],wt=i.slice(l).join("/");if(pe instanceof RegExp){const M=pe.exec(wt);if(M){if(k[Ge]=M[0],r.push(...b(this,z,K).call(this,O,t,c(y,S),k)),Object.keys(c(O,E)).length){h(O,S,k);const Pe=((s=M[0].match(/\//))==null?void 0:s.length)??0;(d[Pe]||(d[Pe]=[])).push(O)}continue}}(pe===!0||pe.test(g))&&(k[Ge]=g,f?(r.push(...b(this,z,K).call(this,O,t,k,c(y,S))),c(O,E)["*"]&&r.push(...b(this,z,K).call(this,c(O,E)["*"],t,k,c(y,S)))):(h(O,S,k),x.push(O)))}}o=x.concat(d.shift()??[])}return r.length>1&&r.sort((l,u)=>l.score-u.score),[r.map(({handler:l,params:u})=>[l,u])]}},W=new WeakMap,E=new WeakMap,Q=new WeakMap,ue=new WeakMap,S=new WeakMap,z=new WeakSet,K=function(t,a,r,n){const o=[];for(let i=0,d=c(t,W).length;i<d;i++){const s=c(t,W)[i],l=s[a]||s[w],u={};if(l!==void 0&&(l.params=Object.create(null),o.push(l),r!==me||n&&n!==me))for(let g=0,f=l.possibleKeys.length;g<f;g++){const x=l.possibleKeys[g],T=u[l.score];l.params[x]=n!=null&&n[x]&&!T?n[x]:r[x]??(n==null?void 0:n[x]),u[l.score]=!0}}return o},ge),ee,at,ra=(at=class{constructor(){p(this,"name","TrieRouter");m(this,ee);h(this,ee,new aa)}add(e,t,a){const r=ot(t);if(r){for(let n=0,o=r.length;n<o;n++)c(this,ee).insert(e,r[n],a);return}c(this,ee).insert(e,t,a)}match(e,t){return c(this,ee).search(e,t)}},ee=new WeakMap,at),xt=class extends qt{constructor(e={}){super(e),this.router=e.router??new ta({routers:[new ea,new ra]})}},na=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(o=>typeof o=="string"?o==="*"?()=>o:i=>o===i?i:null:typeof o=="function"?o:i=>o.includes(i)?i:null)(a.origin),n=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(a.allowMethods);return async function(i,d){var u;function s(g,f){i.res.headers.set(g,f)}const l=await r(i.req.header("origin")||"",i);if(l&&s("Access-Control-Allow-Origin",l),a.credentials&&s("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&s("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&s("Vary","Origin"),a.maxAge!=null&&s("Access-Control-Max-Age",a.maxAge.toString());const g=await n(i.req.header("origin")||"",i);g.length&&s("Access-Control-Allow-Methods",g.join(","));let f=a.allowHeaders;if(!(f!=null&&f.length)){const x=i.req.header("Access-Control-Request-Headers");x&&(f=x.split(/\s*,\s*/))}return f!=null&&f.length&&(s("Access-Control-Allow-Headers",f.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await d(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};const C=new xt;C.use("/api/*",na());const Me="cf2a50987a92a698e89d5efeb80cde82",Fe={face:"https://iili.io/fM9hV6B.png",outfit:"https://iili.io/fM99P3l.png",logo:"https://iili.io/fEiEfUB.png"};C.get("/api/bases",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=await fetch("https://api.airtable.com/v0/meta/bases",{headers:{Authorization:`Bearer ${t}`}});return e.json(await a.json())});C.get("/api/bases/:baseId/tables",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.param("baseId"),r=await fetch(`https://api.airtable.com/v0/meta/bases/${a}/tables`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await r.json())});C.get("/api/records",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.query("filter")||"";if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);let o=`https://api.airtable.com/v0/${a}/${r}?pageSize=50`;n&&n!=="all"&&(o+=`&filterByFormula={Status}='${n}'`);const i=await fetch(o,{headers:{Authorization:`Bearer ${t}`}});return e.json(await i.json())});C.get("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id");if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const o=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await o.json())});C.patch("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id"),o=await e.req.json();if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const i=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{method:"PATCH",headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({fields:o})});return e.json(await i.json())});C.post("/api/generate-image",async e=>{const{prompt:t,imageUrls:a,aspectRatio:r}=await e.req.json(),n={model:"google/nano-banana",input:{prompt:t,image_urls:a||[Fe.face,Fe.outfit,Fe.logo],image_size:r||"16:9",output_format:"png"}};console.log("KieAI Nano Banana Request:",JSON.stringify(n,null,2));const o=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${Me}`,"Content-Type":"application/json"},body:JSON.stringify(n)});return e.json(await o.json())});const Ke={"16:9":"https://iili.io/fk9ypqB.png","9:16":"https://iili.io/fk9yy0P.png","1:1":"https://iili.io/fkH99g1.png"};C.post("/api/generate-image-ideogram",async e=>{const{prompt:t,imageUrl:a,aspectRatio:r}=await e.req.json(),n=Ke[r]||Ke["16:9"],o={model:"ideogram/character-edit",input:{prompt:t,image_url:a,mask_url:n,rendering_speed:"BALANCED",style:"AUTO",expand_prompt:!1,num_images:"1"}};console.log("Ideogram character-edit Request (text overlay):",JSON.stringify(o,null,2));const i=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${Me}`,"Content-Type":"application/json"},body:JSON.stringify(o)});return e.json(await i.json())});C.get("/api/task-status/:taskId",async e=>{const t=e.req.param("taskId"),a=await fetch(`https://api.kie.ai/api/v1/jobs/recordInfo?taskId=${t}`,{headers:{Authorization:`Bearer ${Me}`}});return e.json(await a.json())});C.post("/api/upload-image",async e=>{const{base64Image:t}=await e.req.json(),a=new FormData;a.append("key","6d207e02198a847aa98d0a2a901485a5"),a.append("action","upload"),a.append("source",t),a.append("format","json");const r=await fetch("https://freeimage.host/api/1/upload",{method:"POST",body:a});return e.json(await r.json())});C.post("/api/proxy-image",async e=>{try{const{imageUrl:t}=await e.req.json();if(!t)return e.json({error:"Missing imageUrl"},400);const a=await fetch(t);if(!a.ok)return e.json({error:"Failed to fetch image: "+a.status},500);const r=await a.arrayBuffer(),n=new Uint8Array(r);let o="";for(let s=0;s<n.length;s++)o+=String.fromCharCode(n[s]);const i=btoa(o),d=a.headers.get("content-type")||"image/png";return e.json({success:!0,base64:i,contentType:d,dataUrl:"data:"+d+";base64,"+i})}catch(t){return e.json({error:"Proxy error: "+t.message},500)}});const $e={crypto:{baseId:"appgyL5gKf8rjaJPv",tableId:"tblZwA0JCNPeORaGi",fieldMap:{url:"sourceURL",title:"sourceHeadline",notes:"sourceSummary",platforms:"socialChannels",status:"Status",statusValue:"Needs Approval"}},ai:{baseId:"appgyL5gKf8rjaJPv",tableId:"tblSXrbwYXTQC7D2u",fieldMap:{url:"sourceURL",title:"sourceHeadline",notes:"sourceSummary",platforms:"socialChannels",status:"Status",statusValue:"Needs Approval"}},general:{baseId:"appQggEi0kxkoSmLn",tableId:"tblhAFDUnMcdO8DLk",fieldMap:{url:"Video URL",title:"Video Title",notes:"Notes",platforms:"Platforms",status:"Status",statusValue:"Pending Review"}}},oa=["Twitter","LinkedIn","Blog","Instagram","Facebook","Avatar"],He="patzmYCtUSKROFbsw.ebdd70b78b2f422fd5a6da1aa867be11f690a795117c9e13d9d4747708018921";async function ia(e,t,a,r,n){var s,l,u;const o=r==="ai"?"AI/technology":"crypto";return((u=(l=(s=(await(await fetch("https://api.perplexity.ai/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({model:"sonar-pro",messages:[{role:"user",content:`You are a professional ${o} news researcher.
...
Write in clear, factual prose. No JSON needed - just a well-written report.`}]})})).json()).choices)==null?void 0:s[0])==null?void 0:l.message)==null?void 0:u.content)||""}async function sa(e,t,a,r){var l,u,g;const n=a==="ai"?`You are "5th Ave Angel", a sharp AI/technology commentator and creative director.
...
- Style: cinematic, editorial, professional, photorealistic, 16:9`:`You are "5th Ave Angel", a sharp crypto commentator and creative director.
...
- 2-4 sentences maximum
- ALWAYS include the blonde woman as the main subject
- Style: cinematic, editorial, professional, photorealistic, 16:9`,o=a==="ai"?"AI/technology":"crypto",s=((g=(u=(l=(await(await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${r}`,"Content-Type":"application/json"},body:JSON.stringify({model:"gpt-4o",temperature:.7,messages:[{role:"system",content:n},{role:"user",content:`HEADLINE: ${e}

RESEARCH: ${t}

Create an image prompt featuring 5th Ave Angel in a scene related to this ${o} story.

Return ONLY: {"image_prompt": "A professional blonde woman in her mid-30s wearing [attire] [action] in [setting]. [Details]. [Lighting]. Cinematic, editorial, photorealistic, 16:9."}`}]})})).json()).choices)==null?void 0:l[0])==null?void 0:u.message)==null?void 0:g.content)||"";try{return JSON.parse(s).image_prompt||""}catch{const f=s.match(/"image_prompt"\s*:\s*"([^"]+)"/);return f?f[1]:s}}async function la(e,t,a,r){var l,u,g;const n=a==="ai"?"AI technology":"crypto",o=a==="ai"?`You are "5th Ave Angel" — a sharp, insightful AI technology commentator.

You speak clearly, confidently, and assume the audience is smart but busy.
You care about how AI impacts everyday people, businesses, and society — not just the tech industry hype cycle.`:`You are "5th Ave Angel" — a sharp, no-BS crypto commentator.

You speak clearly, confidently, and assume the audience is smart but busy.
You care about self-banking, Bitcoin adoption, and real-world impact, not price noise.`,s=((g=(u=(l=(await(await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${r}`,"Content-Type":"application/json"},body:JSON.stringify({model:"gpt-4o",temperature:.7,messages:[{role:"system",content:`${o}

Your job is to take a ${n} news story and create platform-specific social media content.

RULES:
- Always return valid JSON only, no markdown, no backticks, no explanation
- Every field must be populated
- Be direct, conversational, and insightful`},{role:"user",content:`HEADLINE: ${e}
...
}`}]})})).json()).choices)==null?void 0:l[0])==null?void 0:u.message)==null?void 0:g.content)||"{}";try{return JSON.parse(s)}catch{const f=s.match(/\{[\s\S]*\}/);return f?JSON.parse(f[0]):{}}}async function ca(e,t,a,r){await fetch(`https://api.airtable.com/v0/${t}/${a}/${e}`,{method:"PATCH",headers:{Authorization:`Bearer ${He}`,"Content-Type":"application/json"},body:JSON.stringify({fields:r})})}async function yt(e,t,a,r,n,o,i,d,s){try{console.log(`[Instant Process] Starting for record ${e} (${n})`),console.log("[Instant Process] Step 1: Researching URL via Perplexity...");const l=await ia(t,a,r,n,d);console.log(`[Instant Process] Research complete: ${l.length} chars`),console.log("[Instant Process] Step 2: Generating image prompt + social content in parallel...");const[u,g]=await Promise.all([sa(a,l,n,s),la(a,l,n,s)]);console.log(`[Instant Process] Image prompt: ${u.length} chars`),console.log(`[Instant Process] Social content fields: ${Object.keys(g).length}`),console.log("[Instant Process] Step 3: Saving all content to Airtable...");const f={imagePrompt:u,sourceSummary:l,...g};await ca(e,o,i,f),console.log(`[Instant Process] DONE! Record ${e} fully enriched.`)}catch(l){console.error(`[Instant Process] ERROR for record ${e}:`,l.message||l)}}C.post("/api/save",async e=>{var t,a;try{const{url:r,title:n,notes:o,platforms:i,topic:d}=await e.req.json();if(!r)return e.json({success:!1,error:"URL is required"},400);const s=d||"general",l=$e[s];if(!l)return e.json({success:!1,error:"Invalid topic. Use: crypto, ai, or general"},400);const u=l.fieldMap,g={};if(g[u.url]=r,g[u.title]=n||"",g[u.status]=u.statusValue,o&&(g[u.notes]=o),i&&i.length>0)if(s==="crypto"||s==="ai"){const v=i.filter(B=>oa.includes(B));v.length>0&&(g[u.platforms]=v)}else g[u.platforms]=i;s==="general"&&(g["Created Date"]=new Date().toISOString());const x=await(await fetch(`https://api.airtable.com/v0/${l.baseId}/${l.tableId}`,{method:"POST",headers:{Authorization:`Bearer ${He}`,"Content-Type":"application/json"},body:JSON.stringify({fields:g})})).json();if(x.error)return console.error("Airtable error:",x.error),e.json({success:!1,error:x.error.message||"Airtable error"},500);const T=((t=e.env)==null?void 0:t.PERPLEXITY_API_KEY)||"",L=((a=e.env)==null?void 0:a.OPENAI_API_KEY)||"";let y=!1;if((s==="crypto"||s==="ai")&&T&&L&&x.id){y=!0;const v=x.id,k=yt(v,r,n||"",o||"",s,l.baseId,l.tableId,T,L);e.executionCtx&&typeof e.executionCtx.waitUntil=="function"?e.executionCtx.waitUntil(k):k.catch(De=>console.error("[Instant Process] Background error:",De))}return e.json({success:!0,record:x,topic:s,table:s==="general"?"Content Pipeline":s==="crypto"?"Social Posts":"Social Posts - AI",processing:y?"started":s==="general"?"not_applicable":"no_api_keys"})}catch(r){return console.error("Save error:",r),e.json({success:!1,error:r.message||"Server error"},500)}});C.get("/api/process-status/:recordId",async e=>{try{const t=e.req.param("recordId"),a=e.req.query("topic")||"crypto",r=$e[a];if(!r)return e.json({error:"Invalid topic"},400);const i=(await(await fetch(`https://api.airtable.com/v0/${r.baseId}/${r.tableId}/${t}`,{headers:{Authorization:`Bearer ${He}`}})).json()).fields||{},d=!!(i.sourceSummary&&i.sourceSummary.length>50),s=!!(i.imagePrompt&&i.imagePrompt.length>10),l=!!(i.twitterCopy&&i.twitterCopy.length>5);let u="processing";return d&&s&&l?u="complete":d&&(u="generating_content"),e.json({recordId:t,status:u,fields:{hasResearch:d,hasImagePrompt:s,hasSocialContent:l,rewrittenHeadline:i.rewrittenHeadline||null}})}catch(t){return e.json({error:t.message},500)}});C.post("/api/process",async e=>{var t,a;try{const{recordId:r,topic:n}=await e.req.json();if(!r||!n)return e.json({error:"recordId and topic are required"},400);const o=$e[n];if(!o||n==="general")return e.json({error:"Processing only available for crypto/ai topics"},400);const i=((t=e.env)==null?void 0:t.PERPLEXITY_API_KEY)||"",d=((a=e.env)==null?void 0:a.OPENAI_API_KEY)||"";if(!i||!d)return e.json({error:"API keys not configured. Set PERPLEXITY_API_KEY and OPENAI_API_KEY."},500);const u=(await(await fetch(`https://api.airtable.com/v0/${o.baseId}/${o.tableId}/${r}`,{headers:{Authorization:`Bearer ${He}`}})).json()).fields||{},g=yt(r,u.sourceURL||"",u.sourceHeadline||"",u.sourceSummary||"",n,o.baseId,o.tableId,i,d);return e.executionCtx&&typeof e.executionCtx.waitUntil=="function"?e.executionCtx.waitUntil(g):g.catch(f=>console.error("[Manual Process] Background error:",f)),e.json({success:!0,status:"processing_started",recordId:r})}catch(r){return e.json({error:r.message},500)}});C.get("/api/topics",e=>e.json({topics:[{id:"crypto",label:"🪙 Crypto News",description:"Save to 5th Ave Crypto pipeline"},{id:"ai",label:"🤖 AI News",description:"Save to 5th Ave AI pipeline"},{id:"general",label:"📋 General Pipeline",description:"Save to Content Pipeline"}]}));C.get("/",e=>e.html(`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body class="text-gray-100">
  ...
  `));const Je=new xt,da=Object.assign({"/src/index.tsx":C});let vt=!1;for(const[,e]of Object.entries(da))e&&(Je.route("/",e),Je.notFound(e.notFoundHandler),vt=!0);if(!vt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Je as default};
