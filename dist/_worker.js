var xt=Object.defineProperty;var Ue=e=>{throw TypeError(e)};var vt=(e,t,a)=>t in e?xt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var h=(e,t,a)=>vt(e,typeof t!="symbol"?t+"":t,a),Be=(e,t,a)=>t.has(e)||Ue("Cannot "+a);var s=(e,t,a)=>(Be(e,t,"read from private field"),a?a.call(e):t.get(e)),m=(e,t,a)=>t.has(e)?Ue("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),f=(e,t,a,r)=>(Be(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),b=(e,t,a)=>(Be(e,t,"access private method"),a);var Ne=(e,t,a,r)=>({set _(n){f(e,t,n,a)},get _(){return s(e,t,r)}});var $e=(e,t,a)=>(r,n)=>{let o=-1;return i(0);async function i(c){if(c<=o)throw new Error("next() called multiple times");o=c;let l,d=!1,u;if(e[c]?(u=e[c][0][0],r.req.routeIndex=c):u=c===e.length&&n||void 0,u)try{l=await u(r,()=>i(c+1))}catch(g){if(g instanceof Error&&t)r.error=g,l=await t(g,r),d=!0;else throw g}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||d)&&(r.res=l),r}},yt=Symbol(),wt=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,o=(e instanceof rt?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?It(e,{all:a,dot:r}):{}};async function It(e,t){const a=await e.formData();return a?Tt(a,t):{}}function Tt(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?Et(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(St(a,r,n),delete a[r])}),a}var Et=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},St=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((o,i)=>{i===n.length-1?r[o]=a:((!r[o]||typeof r[o]!="object"||Array.isArray(r[o])||r[o]instanceof File)&&(r[o]=Object.create(null)),r=r[o])})},Je=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Ct=e=>{const{groups:t,path:a}=kt(e),r=Je(a);return Rt(r,t)},kt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},Rt=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},Se={},Lt=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return Se[r]||(a[2]?Se[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Se[r]=[e,a[1],!0]),Se[r]}return null},ze=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},At=e=>ze(e,decodeURI),Qe=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const o=t.indexOf("?",r),i=t.slice(a,o===-1?void 0:o);return At(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(n===63)break}return t.slice(a,r)},Dt=e=>{const t=Qe(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},re=(e,t,...a)=>(a.length&&(t=re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),et=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const o=n.replace("?","");r+="/"+o,a.push(r)}else r+="/"+n}),a.filter((n,o,i)=>i.indexOf(n)===o)},Fe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?ze(e,at):e):e,tt=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const c=e.charCodeAt(i+t.length+1);if(c===61){const l=i+t.length+2,d=e.indexOf("&",l);return Fe(e.slice(l,d===-1?void 0:d))}else if(c==38||isNaN(c))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const i=e.indexOf("&",o+1);let c=e.indexOf("=",o);c>i&&i!==-1&&(c=-1);let l=e.slice(o+1,c===-1?i===-1?void 0:i:c);if(r&&(l=Fe(l)),o=i,l==="")continue;let d;c===-1?d="":(d=e.slice(c+1,i===-1?void 0:i),r&&(d=Fe(d))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},Ht=tt,Bt=(e,t)=>tt(e,t,!0),at=decodeURIComponent,Ge=e=>ze(e,at),se,k,z,nt,ot,je,$,Ze,rt=(Ze=class{constructor(e,t="/",a=[[]]){m(this,z);h(this,"raw");m(this,se);m(this,k);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});m(this,$,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,f(this,k,a),f(this,se,{})}param(e){return e?b(this,z,nt).call(this,e):b(this,z,ot).call(this)}query(e){return Ht(this.url,e)}queries(e){return Bt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await wt(this,e))}json(){return s(this,$).call(this,"text").then(e=>JSON.parse(e))}text(){return s(this,$).call(this,"text")}arrayBuffer(){return s(this,$).call(this,"arrayBuffer")}blob(){return s(this,$).call(this,"blob")}formData(){return s(this,$).call(this,"formData")}addValidatedData(e,t){s(this,se)[e]=t}valid(e){return s(this,se)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[yt](){return s(this,k)}get matchedRoutes(){return s(this,k)[0].map(([[,e]])=>e)}get routePath(){return s(this,k)[0].map(([[,e]])=>e)[this.routeIndex].path}},se=new WeakMap,k=new WeakMap,z=new WeakSet,nt=function(e){const t=s(this,k)[0][this.routeIndex][1][e],a=b(this,z,je).call(this,t);return a&&/\%/.test(a)?Ge(a):a},ot=function(){const e={},t=Object.keys(s(this,k)[0][this.routeIndex][1]);for(const a of t){const r=b(this,z,je).call(this,s(this,k)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Ge(r):r)}return e},je=function(e){return s(this,k)[1]?s(this,k)[1][e]:e},$=new WeakMap,Ze),Ft={Stringify:1},st=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(n?n[0]+=e:n=[e],Promise.all(o.map(c=>c({phase:t,buffer:n,context:r}))).then(c=>Promise.all(c.filter(Boolean).map(l=>st(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},Ot="text/plain; charset=UTF-8",Oe=(e,t)=>({"Content-Type":e,...t}),be,xe,F,ie,O,S,ve,le,de,V,ye,we,G,ne,Ye,Pt=(Ye=class{constructor(e,t){m(this,G);m(this,be);m(this,xe);h(this,"env",{});m(this,F);h(this,"finalized",!1);h(this,"error");m(this,ie);m(this,O);m(this,S);m(this,ve);m(this,le);m(this,de);m(this,V);m(this,ye);m(this,we);h(this,"render",(...e)=>(s(this,le)??f(this,le,t=>this.html(t)),s(this,le).call(this,...e)));h(this,"setLayout",e=>f(this,ve,e));h(this,"getLayout",()=>s(this,ve));h(this,"setRenderer",e=>{f(this,le,e)});h(this,"header",(e,t,a)=>{this.finalized&&f(this,S,new Response(s(this,S).body,s(this,S)));const r=s(this,S)?s(this,S).headers:s(this,V)??f(this,V,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});h(this,"status",e=>{f(this,ie,e)});h(this,"set",(e,t)=>{s(this,F)??f(this,F,new Map),s(this,F).set(e,t)});h(this,"get",e=>s(this,F)?s(this,F).get(e):void 0);h(this,"newResponse",(...e)=>b(this,G,ne).call(this,...e));h(this,"body",(e,t,a)=>b(this,G,ne).call(this,e,t,a));h(this,"text",(e,t,a)=>!s(this,V)&&!s(this,ie)&&!t&&!a&&!this.finalized?new Response(e):b(this,G,ne).call(this,e,t,Oe(Ot,a)));h(this,"json",(e,t,a)=>b(this,G,ne).call(this,JSON.stringify(e),t,Oe("application/json",a)));h(this,"html",(e,t,a)=>{const r=n=>b(this,G,ne).call(this,n,t,Oe("text/html; charset=UTF-8",a));return typeof e=="object"?st(e,Ft.Stringify,!1,{}).then(r):r(e)});h(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});h(this,"notFound",()=>(s(this,de)??f(this,de,()=>new Response),s(this,de).call(this,this)));f(this,be,e),t&&(f(this,O,t.executionCtx),this.env=t.env,f(this,de,t.notFoundHandler),f(this,we,t.path),f(this,ye,t.matchResult))}get req(){return s(this,xe)??f(this,xe,new rt(s(this,be),s(this,we),s(this,ye))),s(this,xe)}get event(){if(s(this,O)&&"respondWith"in s(this,O))return s(this,O);throw Error("This context has no FetchEvent")}get executionCtx(){if(s(this,O))return s(this,O);throw Error("This context has no ExecutionContext")}get res(){return s(this,S)||f(this,S,new Response(null,{headers:s(this,V)??f(this,V,new Headers)}))}set res(e){if(s(this,S)&&e){e=new Response(e.body,e);for(const[t,a]of s(this,S).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=s(this,S).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}f(this,S,e),this.finalized=!0}get var(){return s(this,F)?Object.fromEntries(s(this,F)):{}}},be=new WeakMap,xe=new WeakMap,F=new WeakMap,ie=new WeakMap,O=new WeakMap,S=new WeakMap,ve=new WeakMap,le=new WeakMap,de=new WeakMap,V=new WeakMap,ye=new WeakMap,we=new WeakMap,G=new WeakSet,ne=function(e,t,a){const r=s(this,S)?new Headers(s(this,S).headers):s(this,V)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,c]of o)i.toLowerCase()==="set-cookie"?r.append(i,c):r.set(i,c)}if(a)for(const[o,i]of Object.entries(a))if(typeof i=="string")r.set(o,i);else{r.delete(o);for(const c of i)r.append(o,c)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??s(this,ie);return new Response(e,{status:n,headers:r})},Ye),y="ALL",jt="all",zt=["get","post","put","delete","options","patch"],it="Can not add a route since the matcher is already built.",lt=class extends Error{},Mt="__COMPOSED_HANDLER",Ut=e=>e.text("404 Not Found",404),_e=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},L,w,dt,A,W,Ce,ke,ce,Nt=(ce=class{constructor(t={}){m(this,w);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");m(this,L,"/");h(this,"routes",[]);m(this,A,Ut);h(this,"errorHandler",_e);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(f(this,A,t),this));h(this,"fetch",(t,...a)=>b(this,w,ke).call(this,t,a[1],a[0],t.method));h(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${re("/",t)}`,a),r,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,w,ke).call(this,t.request,t,void 0,t.request.method))})});[...zt,jt].forEach(o=>{this[o]=(i,...c)=>(typeof i=="string"?f(this,L,i):b(this,w,W).call(this,o,s(this,L),i),c.forEach(l=>{b(this,w,W).call(this,o,s(this,L),l)}),this)}),this.on=(o,i,...c)=>{for(const l of[i].flat()){f(this,L,l);for(const d of[o].flat())c.map(u=>{b(this,w,W).call(this,d.toUpperCase(),s(this,L),u)})}return this},this.use=(o,...i)=>(typeof o=="string"?f(this,L,o):(f(this,L,"*"),i.unshift(o)),i.forEach(c=>{b(this,w,W).call(this,y,s(this,L),c)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??Qe:Dt}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let o;a.errorHandler===_e?o=n.handler:(o=async(c,l)=>(await $e([],a.errorHandler)(c,()=>n.handler(c,l))).res,o[Mt]=n.handler),b(i=r,w,W).call(i,n.method,n.path,o)}),this}basePath(t){const a=b(this,w,dt).call(this);return a._basePath=re(this._basePath,t),a}mount(t,a,r){let n,o;r&&(typeof r=="function"?o=r:(o=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=o?l=>{const d=o(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=re(this._basePath,t),d=l==="/"?0:l.length;return u=>{const g=new URL(u.url);return g.pathname=g.pathname.slice(d)||"/",new Request(g,u)}})());const c=async(l,d)=>{const u=await a(n(l.req.raw),...i(l));if(u)return u;await d()};return b(this,w,W).call(this,y,re(t,"*"),c),this}},L=new WeakMap,w=new WeakSet,dt=function(){const t=new ce({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,A,s(this,A)),t.routes=this.routes,t},A=new WeakMap,W=function(t,a,r){t=t.toUpperCase(),a=re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},Ce=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ke=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,w,ke).call(this,t,a,r,"GET")))();const o=this.getPath(t,{env:r}),i=this.router.match(n,o),c=new Pt(t,{path:o,matchResult:i,env:r,executionCtx:a,notFoundHandler:s(this,A)});if(i[0].length===1){let d;try{d=i[0][0][0][0](c,async()=>{c.res=await s(this,A).call(this,c)})}catch(u){return b(this,w,Ce).call(this,u,c)}return d instanceof Promise?d.then(u=>u||(c.finalized?c.res:s(this,A).call(this,c))).catch(u=>b(this,w,Ce).call(this,u,c)):d??s(this,A).call(this,c)}const l=$e(i[0],this.errorHandler,s(this,A));return(async()=>{try{const d=await l(c);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return b(this,w,Ce).call(this,d,c)}})()},ce),ct=[];function $t(e,t){const a=this.buildAllMatchers(),r=(n,o)=>{const i=a[n]||a[y],c=i[2][o];if(c)return c;const l=o.match(i[0]);if(!l)return[[],ct];const d=l.indexOf("",1);return[i[1][d],l]};return this.match=r,r(e,t)}var Le="[^/]+",me=".*",pe="(?:|/.*)",oe=Symbol(),Gt=new Set(".\\+*[^]$()");function _t(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===me||e===pe?1:t===me||t===pe?-1:e===Le?1:t===Le?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var X,J,D,te,qt=(te=class{constructor(){m(this,X);m(this,J);m(this,D,Object.create(null))}insert(t,a,r,n,o){if(t.length===0){if(s(this,X)!==void 0)throw oe;if(o)return;f(this,X,a);return}const[i,...c]=t,l=i==="*"?c.length===0?["","",me]:["","",Le]:i==="/*"?["","",pe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let g=l[2]||Le;if(u&&l[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw oe;if(d=s(this,D)[g],!d){if(Object.keys(s(this,D)).some(p=>p!==me&&p!==pe))throw oe;if(o)return;d=s(this,D)[g]=new te,u!==""&&f(d,J,n.varIndex++)}!o&&u!==""&&r.push([u,s(d,J)])}else if(d=s(this,D)[i],!d){if(Object.keys(s(this,D)).some(u=>u.length>1&&u!==me&&u!==pe))throw oe;if(o)return;d=s(this,D)[i]=new te}d.insert(c,a,r,n,o)}buildRegExpStr(){const a=Object.keys(s(this,D)).sort(_t).map(r=>{const n=s(this,D)[r];return(typeof s(n,J)=="number"?`(${r})@${s(n,J)}`:Gt.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof s(this,X)=="number"&&a.unshift(`#${s(this,X)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},X=new WeakMap,J=new WeakMap,D=new WeakMap,te),Ae,Ie,We,Zt=(We=class{constructor(){m(this,Ae,{varIndex:0});m(this,Ie,new qt)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let c=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return n[i]=[d,l],i++,c=!0,d}),!c)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[c]=n[i];for(let l=o.length-1;l>=0;l--)if(o[l].indexOf(c)!==-1){o[l]=o[l].replace(c,n[i][1]);break}}return s(this,Ie).insert(o,t,r,s(this,Ae),a),r}buildRegExp(){let e=s(this,Ie).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,i)=>o!==void 0?(a[++t]=Number(o),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},Ae=new WeakMap,Ie=new WeakMap,We),Yt=[/^$/,[],Object.create(null)],Re=Object.create(null);function ut(e){return Re[e]??(Re[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Wt(){Re=Object.create(null)}function Kt(e){var d;const t=new Zt,a=[];if(e.length===0)return Yt;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,g],[p,v])=>u?1:p?-1:g.length-v.length),n=Object.create(null);for(let u=0,g=-1,p=r.length;u<p;u++){const[v,C,M]=r[u];v?n[C]=[M.map(([E])=>[E,Object.create(null)]),ct]:g++;let x;try{x=t.insert(C,g,v)}catch(E){throw E===oe?new lt(C):E}v||(a[g]=M.map(([E,U])=>{const Te=Object.create(null);for(U-=1;U>=0;U--){const[Ee,H]=x[U];Te[Ee]=H}return[E,Te]}))}const[o,i,c]=t.buildRegExp();for(let u=0,g=a.length;u<g;u++)for(let p=0,v=a[u].length;p<v;p++){const C=(d=a[u][p])==null?void 0:d[1];if(!C)continue;const M=Object.keys(C);for(let x=0,E=M.length;x<E;x++)C[M[x]]=c[C[M[x]]]}const l=[];for(const u in i)l[u]=a[i[u]];return[o,l,n]}function ae(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ut(a).test(t))return[...e[a]]}}var _,q,De,gt,Ke,Vt=(Ke=class{constructor(){m(this,De);h(this,"name","RegExpRouter");m(this,_);m(this,q);h(this,"match",$t);f(this,_,{[y]:Object.create(null)}),f(this,q,{[y]:Object.create(null)})}add(e,t,a){var c;const r=s(this,_),n=s(this,q);if(!r||!n)throw new Error(it);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[y]).forEach(d=>{l[e][d]=[...l[y][d]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ut(t);e===y?Object.keys(r).forEach(d=>{var u;(u=r[d])[t]||(u[t]=ae(r[d],t)||ae(r[y],t)||[])}):(c=r[e])[t]||(c[t]=ae(r[e],t)||ae(r[y],t)||[]),Object.keys(r).forEach(d=>{(e===y||e===d)&&Object.keys(r[d]).forEach(u=>{l.test(u)&&r[d][u].push([a,o])})}),Object.keys(n).forEach(d=>{(e===y||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([a,o]))});return}const i=et(t)||[t];for(let l=0,d=i.length;l<d;l++){const u=i[l];Object.keys(n).forEach(g=>{var p;(e===y||e===g)&&((p=n[g])[u]||(p[u]=[...ae(r[g],u)||ae(r[y],u)||[]]),n[g][u].push([a,o-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(s(this,q)).concat(Object.keys(s(this,_))).forEach(t=>{e[t]||(e[t]=b(this,De,gt).call(this,t))}),f(this,_,f(this,q,void 0)),Wt(),e}},_=new WeakMap,q=new WeakMap,De=new WeakSet,gt=function(e){const t=[];let a=e===y;return[s(this,_),s(this,q)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(o=>[o,r[e][o]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==y&&t.push(...Object.keys(r[y]).map(o=>[o,r[y][o]]))}),a?Kt(t):null},Ke),Z,P,Ve,Xt=(Ve=class{constructor(e){h(this,"name","SmartRouter");m(this,Z,[]);m(this,P,[]);f(this,Z,e.routers)}add(e,t,a){if(!s(this,P))throw new Error(it);s(this,P).push([e,t,a])}match(e,t){if(!s(this,P))throw new Error("Fatal error");const a=s(this,Z),r=s(this,P),n=a.length;let o=0,i;for(;o<n;o++){const c=a[o];try{for(let l=0,d=r.length;l<d;l++)c.add(...r[l]);i=c.match(e,t)}catch(l){if(l instanceof lt)continue;throw l}this.match=c.match.bind(c),f(this,Z,[c]),f(this,P,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(s(this,P)||s(this,Z).length!==1)throw new Error("No active router has been determined yet.");return s(this,Z)[0]}},Z=new WeakMap,P=new WeakMap,Ve),he=Object.create(null),Y,T,Q,ue,I,j,K,ge,Jt=(ge=class{constructor(t,a,r){m(this,j);m(this,Y);m(this,T);m(this,Q);m(this,ue,0);m(this,I,he);if(f(this,T,r||Object.create(null)),f(this,Y,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},f(this,Y,[n])}f(this,Q,[])}insert(t,a,r){f(this,ue,++Ne(this,ue)._);let n=this;const o=Ct(a),i=[];for(let c=0,l=o.length;c<l;c++){const d=o[c],u=o[c+1],g=Lt(d,u),p=Array.isArray(g)?g[0]:d;if(p in s(n,T)){n=s(n,T)[p],g&&i.push(g[1]);continue}s(n,T)[p]=new ge,g&&(s(n,Q).push(g),i.push(g[1])),n=s(n,T)[p]}return s(n,Y).push({[t]:{handler:r,possibleKeys:i.filter((c,l,d)=>d.indexOf(c)===l),score:s(this,ue)}}),n}search(t,a){var l;const r=[];f(this,I,he);let o=[this];const i=Je(a),c=[];for(let d=0,u=i.length;d<u;d++){const g=i[d],p=d===u-1,v=[];for(let C=0,M=o.length;C<M;C++){const x=o[C],E=s(x,T)[g];E&&(f(E,I,s(x,I)),p?(s(E,T)["*"]&&r.push(...b(this,j,K).call(this,s(E,T)["*"],t,s(x,I))),r.push(...b(this,j,K).call(this,E,t,s(x,I)))):v.push(E));for(let U=0,Te=s(x,Q).length;U<Te;U++){const Ee=s(x,Q)[U],H=s(x,I)===he?{}:{...s(x,I)};if(Ee==="*"){const N=s(x,T)["*"];N&&(r.push(...b(this,j,K).call(this,N,t,s(x,I))),f(N,I,H),v.push(N));continue}const[pt,Me,fe]=Ee;if(!g&&!(fe instanceof RegExp))continue;const B=s(x,T)[pt],bt=i.slice(d).join("/");if(fe instanceof RegExp){const N=fe.exec(bt);if(N){if(H[Me]=N[0],r.push(...b(this,j,K).call(this,B,t,s(x,I),H)),Object.keys(s(B,T)).length){f(B,I,H);const He=((l=N[0].match(/\//))==null?void 0:l.length)??0;(c[He]||(c[He]=[])).push(B)}continue}}(fe===!0||fe.test(g))&&(H[Me]=g,p?(r.push(...b(this,j,K).call(this,B,t,H,s(x,I))),s(B,T)["*"]&&r.push(...b(this,j,K).call(this,s(B,T)["*"],t,H,s(x,I)))):(f(B,I,H),v.push(B)))}}o=v.concat(c.shift()??[])}return r.length>1&&r.sort((d,u)=>d.score-u.score),[r.map(({handler:d,params:u})=>[d,u])]}},Y=new WeakMap,T=new WeakMap,Q=new WeakMap,ue=new WeakMap,I=new WeakMap,j=new WeakSet,K=function(t,a,r,n){const o=[];for(let i=0,c=s(t,Y).length;i<c;i++){const l=s(t,Y)[i],d=l[a]||l[y],u={};if(d!==void 0&&(d.params=Object.create(null),o.push(d),r!==he||n&&n!==he))for(let g=0,p=d.possibleKeys.length;g<p;g++){const v=d.possibleKeys[g],C=u[d.score];d.params[v]=n!=null&&n[v]&&!C?n[v]:r[v]??(n==null?void 0:n[v]),u[d.score]=!0}}return o},ge),ee,Xe,Qt=(Xe=class{constructor(){h(this,"name","TrieRouter");m(this,ee);f(this,ee,new Jt)}add(e,t,a){const r=et(t);if(r){for(let n=0,o=r.length;n<o;n++)s(this,ee).insert(e,r[n],a);return}s(this,ee).insert(e,t,a)}match(e,t){return s(this,ee).search(e,t)}},ee=new WeakMap,Xe),ft=class extends Nt{constructor(e={}){super(e),this.router=e.router??new Xt({routers:[new Vt,new Qt]})}},ea=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(o=>typeof o=="string"?o==="*"?()=>o:i=>o===i?i:null:typeof o=="function"?o:i=>o.includes(i)?i:null)(a.origin),n=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(a.allowMethods);return async function(i,c){var u;function l(g,p){i.res.headers.set(g,p)}const d=await r(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const g=await n(i.req.header("origin")||"",i);g.length&&l("Access-Control-Allow-Methods",g.join(","));let p=a.allowHeaders;if(!(p!=null&&p.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(p=v.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await c(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};const R=new ft;R.use("/api/*",ea());const ht="cf2a50987a92a698e89d5efeb80cde82",Pe={face:"https://iili.io/fM9hV6B.png",outfit:"https://iili.io/fM99P3l.png",logo:"https://iili.io/fEiEfUB.png"};R.get("/api/bases",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=await fetch("https://api.airtable.com/v0/meta/bases",{headers:{Authorization:`Bearer ${t}`}});return e.json(await a.json())});R.get("/api/bases/:baseId/tables",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.param("baseId"),r=await fetch(`https://api.airtable.com/v0/meta/bases/${a}/tables`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await r.json())});R.get("/api/records",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.query("filter")||"";if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);let o=`https://api.airtable.com/v0/${a}/${r}?pageSize=50`;n&&n!=="all"&&(o+=`&filterByFormula={Status}='${n}'`);const i=await fetch(o,{headers:{Authorization:`Bearer ${t}`}});return e.json(await i.json())});R.get("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id");if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const o=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await o.json())});R.patch("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id"),o=await e.req.json();if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const i=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{method:"PATCH",headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({fields:o})});return e.json(await i.json())});R.post("/api/generate-image",async e=>{const{prompt:t,imageUrls:a,aspectRatio:r}=await e.req.json(),n={model:"google/nano-banana",input:{prompt:t,image_urls:a||[Pe.face,Pe.outfit,Pe.logo],aspect_ratio:r||"16:9",aspectRatio:r||"16:9",ratio:r||"16:9",resolution:"1K",output_format:"png"},aspect_ratio:r||"16:9",aspectRatio:r||"16:9"};console.log("KieAI Request:",JSON.stringify(n,null,2));const o=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${ht}`,"Content-Type":"application/json"},body:JSON.stringify(n)});return e.json(await o.json())});R.get("/api/task-status/:taskId",async e=>{const t=e.req.param("taskId"),a=await fetch(`https://api.kie.ai/api/v1/jobs/recordInfo?taskId=${t}`,{headers:{Authorization:`Bearer ${ht}`}});return e.json(await a.json())});R.post("/api/upload-image",async e=>{const{base64Image:t}=await e.req.json(),a=new FormData;a.append("key","6d207e02198a847aa98d0a2a901485a5"),a.append("action","upload"),a.append("source",t),a.append("format","json");const r=await fetch("https://freeimage.host/api/1/upload",{method:"POST",body:a});return e.json(await r.json())});R.post("/api/proxy-image",async e=>{try{const{imageUrl:t}=await e.req.json();if(!t)return e.json({error:"Missing imageUrl"},400);const a=await fetch(t);if(!a.ok)return e.json({error:"Failed to fetch image: "+a.status},500);const r=await a.arrayBuffer(),n=new Uint8Array(r);let o="";for(let l=0;l<n.length;l++)o+=String.fromCharCode(n[l]);const i=btoa(o),c=a.headers.get("content-type")||"image/png";return e.json({success:!0,base64:i,contentType:c,dataUrl:"data:"+c+";base64,"+i})}catch(t){return e.json({error:"Proxy error: "+t.message},500)}});R.get("/",e=>e.html(`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body class="text-gray-100">
  ...
  `));const qe=new ft,ta=Object.assign({"/src/index.tsx":R});let mt=!1;for(const[,e]of Object.entries(ta))e&&(qe.route("/",e),qe.notFound(e.notFoundHandler),mt=!0);if(!mt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{qe as default};
