var vt=Object.defineProperty;var Me=e=>{throw TypeError(e)};var yt=(e,t,a)=>t in e?vt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var h=(e,t,a)=>yt(e,typeof t!="symbol"?t+"":t,a),De=(e,t,a)=>t.has(e)||Me("Cannot "+a);var s=(e,t,a)=>(De(e,t,"read from private field"),a?a.call(e):t.get(e)),m=(e,t,a)=>t.has(e)?Me("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),f=(e,t,a,r)=>(De(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),b=(e,t,a)=>(De(e,t,"access private method"),a);var $e=(e,t,a,r)=>({set _(n){f(e,t,n,a)},get _(){return s(e,t,r)}});var Ge=(e,t,a)=>(r,n)=>{let o=-1;return i(0);async function i(c){if(c<=o)throw new Error("next() called multiple times");o=c;let l,d=!1,u;if(e[c]?(u=e[c][0][0],r.req.routeIndex=c):u=c===e.length&&n||void 0,u)try{l=await u(r,()=>i(c+1))}catch(g){if(g instanceof Error&&t)r.error=g,l=await t(g,r),d=!0;else throw g}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||d)&&(r.res=l),r}},wt=Symbol(),It=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,o=(e instanceof ot?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?Tt(e,{all:a,dot:r}):{}};async function Tt(e,t){const a=await e.formData();return a?Ct(a,t):{}}function Ct(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?St(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(Et(a,r,n),delete a[r])}),a}var St=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Et=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((o,i)=>{i===n.length-1?r[o]=a:((!r[o]||typeof r[o]!="object"||Array.isArray(r[o])||r[o]instanceof File)&&(r[o]=Object.create(null)),r=r[o])})},et=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},kt=e=>{const{groups:t,path:a}=Rt(e),r=et(a);return At(r,t)},Rt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},At=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},Se={},Lt=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return Se[r]||(a[2]?Se[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Se[r]=[e,a[1],!0]),Se[r]}return null},Ue=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Bt=e=>Ue(e,decodeURI),tt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const o=t.indexOf("?",r),i=t.slice(a,o===-1?void 0:o);return Bt(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(n===63)break}return t.slice(a,r)},Ht=e=>{const t=tt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},re=(e,t,...a)=>(a.length&&(t=re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),at=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const o=n.replace("?","");r+="/"+o,a.push(r)}else r+="/"+n}),a.filter((n,o,i)=>i.indexOf(n)===o)},Oe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ue(e,nt):e):e,rt=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const c=e.charCodeAt(i+t.length+1);if(c===61){const l=i+t.length+2,d=e.indexOf("&",l);return Oe(e.slice(l,d===-1?void 0:d))}else if(c==38||isNaN(c))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const i=e.indexOf("&",o+1);let c=e.indexOf("=",o);c>i&&i!==-1&&(c=-1);let l=e.slice(o+1,c===-1?i===-1?void 0:i:c);if(r&&(l=Oe(l)),o=i,l==="")continue;let d;c===-1?d="":(d=e.slice(c+1,i===-1?void 0:i),r&&(d=Oe(d))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},Dt=rt,Ot=(e,t)=>rt(e,t,!0),nt=decodeURIComponent,_e=e=>Ue(e,nt),ie,R,U,it,st,je,$,Ye,ot=(Ye=class{constructor(e,t="/",a=[[]]){m(this,U);h(this,"raw");m(this,ie);m(this,R);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});m(this,$,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,f(this,R,a),f(this,ie,{})}param(e){return e?b(this,U,it).call(this,e):b(this,U,st).call(this)}query(e){return Dt(this.url,e)}queries(e){return Ot(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await It(this,e))}json(){return s(this,$).call(this,"text").then(e=>JSON.parse(e))}text(){return s(this,$).call(this,"text")}arrayBuffer(){return s(this,$).call(this,"arrayBuffer")}blob(){return s(this,$).call(this,"blob")}formData(){return s(this,$).call(this,"formData")}addValidatedData(e,t){s(this,ie)[e]=t}valid(e){return s(this,ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[wt](){return s(this,R)}get matchedRoutes(){return s(this,R)[0].map(([[,e]])=>e)}get routePath(){return s(this,R)[0].map(([[,e]])=>e)[this.routeIndex].path}},ie=new WeakMap,R=new WeakMap,U=new WeakSet,it=function(e){const t=s(this,R)[0][this.routeIndex][1][e],a=b(this,U,je).call(this,t);return a&&/\%/.test(a)?_e(a):a},st=function(){const e={},t=Object.keys(s(this,R)[0][this.routeIndex][1]);for(const a of t){const r=b(this,U,je).call(this,s(this,R)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?_e(r):r)}return e},je=function(e){return s(this,R)[1]?s(this,R)[1][e]:e},$=new WeakMap,Ye),Pt={Stringify:1},lt=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(n?n[0]+=e:n=[e],Promise.all(o.map(c=>c({phase:t,buffer:n,context:r}))).then(c=>Promise.all(c.filter(Boolean).map(l=>lt(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},Ft="text/plain; charset=UTF-8",Pe=(e,t)=>({"Content-Type":e,...t}),be,xe,O,se,P,S,ve,le,de,X,ye,we,G,ne,Ke,jt=(Ke=class{constructor(e,t){m(this,G);m(this,be);m(this,xe);h(this,"env",{});m(this,O);h(this,"finalized",!1);h(this,"error");m(this,se);m(this,P);m(this,S);m(this,ve);m(this,le);m(this,de);m(this,X);m(this,ye);m(this,we);h(this,"render",(...e)=>(s(this,le)??f(this,le,t=>this.html(t)),s(this,le).call(this,...e)));h(this,"setLayout",e=>f(this,ve,e));h(this,"getLayout",()=>s(this,ve));h(this,"setRenderer",e=>{f(this,le,e)});h(this,"header",(e,t,a)=>{this.finalized&&f(this,S,new Response(s(this,S).body,s(this,S)));const r=s(this,S)?s(this,S).headers:s(this,X)??f(this,X,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});h(this,"status",e=>{f(this,se,e)});h(this,"set",(e,t)=>{s(this,O)??f(this,O,new Map),s(this,O).set(e,t)});h(this,"get",e=>s(this,O)?s(this,O).get(e):void 0);h(this,"newResponse",(...e)=>b(this,G,ne).call(this,...e));h(this,"body",(e,t,a)=>b(this,G,ne).call(this,e,t,a));h(this,"text",(e,t,a)=>!s(this,X)&&!s(this,se)&&!t&&!a&&!this.finalized?new Response(e):b(this,G,ne).call(this,e,t,Pe(Ft,a)));h(this,"json",(e,t,a)=>b(this,G,ne).call(this,JSON.stringify(e),t,Pe("application/json",a)));h(this,"html",(e,t,a)=>{const r=n=>b(this,G,ne).call(this,n,t,Pe("text/html; charset=UTF-8",a));return typeof e=="object"?lt(e,Pt.Stringify,!1,{}).then(r):r(e)});h(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});h(this,"notFound",()=>(s(this,de)??f(this,de,()=>new Response),s(this,de).call(this,this)));f(this,be,e),t&&(f(this,P,t.executionCtx),this.env=t.env,f(this,de,t.notFoundHandler),f(this,we,t.path),f(this,ye,t.matchResult))}get req(){return s(this,xe)??f(this,xe,new ot(s(this,be),s(this,we),s(this,ye))),s(this,xe)}get event(){if(s(this,P)&&"respondWith"in s(this,P))return s(this,P);throw Error("This context has no FetchEvent")}get executionCtx(){if(s(this,P))return s(this,P);throw Error("This context has no ExecutionContext")}get res(){return s(this,S)||f(this,S,new Response(null,{headers:s(this,X)??f(this,X,new Headers)}))}set res(e){if(s(this,S)&&e){e=new Response(e.body,e);for(const[t,a]of s(this,S).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=s(this,S).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}f(this,S,e),this.finalized=!0}get var(){return s(this,O)?Object.fromEntries(s(this,O)):{}}},be=new WeakMap,xe=new WeakMap,O=new WeakMap,se=new WeakMap,P=new WeakMap,S=new WeakMap,ve=new WeakMap,le=new WeakMap,de=new WeakMap,X=new WeakMap,ye=new WeakMap,we=new WeakMap,G=new WeakSet,ne=function(e,t,a){const r=s(this,S)?new Headers(s(this,S).headers):s(this,X)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,c]of o)i.toLowerCase()==="set-cookie"?r.append(i,c):r.set(i,c)}if(a)for(const[o,i]of Object.entries(a))if(typeof i=="string")r.set(o,i);else{r.delete(o);for(const c of i)r.append(o,c)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??s(this,se);return new Response(e,{status:n,headers:r})},Ke),y="ALL",Ut="all",zt=["get","post","put","delete","options","patch"],dt="Can not add a route since the matcher is already built.",ct=class extends Error{},Nt="__COMPOSED_HANDLER",Mt=e=>e.text("404 Not Found",404),qe=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},A,w,ut,L,Y,Ee,ke,ce,$t=(ce=class{constructor(t={}){m(this,w);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");m(this,A,"/");h(this,"routes",[]);m(this,L,Mt);h(this,"errorHandler",qe);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(f(this,L,t),this));h(this,"fetch",(t,...a)=>b(this,w,ke).call(this,t,a[1],a[0],t.method));h(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${re("/",t)}`,a),r,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,w,ke).call(this,t.request,t,void 0,t.request.method))})});[...zt,Ut].forEach(o=>{this[o]=(i,...c)=>(typeof i=="string"?f(this,A,i):b(this,w,Y).call(this,o,s(this,A),i),c.forEach(l=>{b(this,w,Y).call(this,o,s(this,A),l)}),this)}),this.on=(o,i,...c)=>{for(const l of[i].flat()){f(this,A,l);for(const d of[o].flat())c.map(u=>{b(this,w,Y).call(this,d.toUpperCase(),s(this,A),u)})}return this},this.use=(o,...i)=>(typeof o=="string"?f(this,A,o):(f(this,A,"*"),i.unshift(o)),i.forEach(c=>{b(this,w,Y).call(this,y,s(this,A),c)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??tt:Ht}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let o;a.errorHandler===qe?o=n.handler:(o=async(c,l)=>(await Ge([],a.errorHandler)(c,()=>n.handler(c,l))).res,o[Nt]=n.handler),b(i=r,w,Y).call(i,n.method,n.path,o)}),this}basePath(t){const a=b(this,w,ut).call(this);return a._basePath=re(this._basePath,t),a}mount(t,a,r){let n,o;r&&(typeof r=="function"?o=r:(o=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=o?l=>{const d=o(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=re(this._basePath,t),d=l==="/"?0:l.length;return u=>{const g=new URL(u.url);return g.pathname=g.pathname.slice(d)||"/",new Request(g,u)}})());const c=async(l,d)=>{const u=await a(n(l.req.raw),...i(l));if(u)return u;await d()};return b(this,w,Y).call(this,y,re(t,"*"),c),this}},A=new WeakMap,w=new WeakSet,ut=function(){const t=new ce({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,L,s(this,L)),t.routes=this.routes,t},L=new WeakMap,Y=function(t,a,r){t=t.toUpperCase(),a=re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},Ee=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ke=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,w,ke).call(this,t,a,r,"GET")))();const o=this.getPath(t,{env:r}),i=this.router.match(n,o),c=new jt(t,{path:o,matchResult:i,env:r,executionCtx:a,notFoundHandler:s(this,L)});if(i[0].length===1){let d;try{d=i[0][0][0][0](c,async()=>{c.res=await s(this,L).call(this,c)})}catch(u){return b(this,w,Ee).call(this,u,c)}return d instanceof Promise?d.then(u=>u||(c.finalized?c.res:s(this,L).call(this,c))).catch(u=>b(this,w,Ee).call(this,u,c)):d??s(this,L).call(this,c)}const l=Ge(i[0],this.errorHandler,s(this,L));return(async()=>{try{const d=await l(c);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return b(this,w,Ee).call(this,d,c)}})()},ce),gt=[];function Gt(e,t){const a=this.buildAllMatchers(),r=(n,o)=>{const i=a[n]||a[y],c=i[2][o];if(c)return c;const l=o.match(i[0]);if(!l)return[[],gt];const d=l.indexOf("",1);return[i[1][d],l]};return this.match=r,r(e,t)}var Ae="[^/]+",me=".*",pe="(?:|/.*)",oe=Symbol(),_t=new Set(".\\+*[^]$()");function qt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===me||e===pe?1:t===me||t===pe?-1:e===Ae?1:t===Ae?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var V,J,B,te,Zt=(te=class{constructor(){m(this,V);m(this,J);m(this,B,Object.create(null))}insert(t,a,r,n,o){if(t.length===0){if(s(this,V)!==void 0)throw oe;if(o)return;f(this,V,a);return}const[i,...c]=t,l=i==="*"?c.length===0?["","",me]:["","",Ae]:i==="/*"?["","",pe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let g=l[2]||Ae;if(u&&l[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw oe;if(d=s(this,B)[g],!d){if(Object.keys(s(this,B)).some(p=>p!==me&&p!==pe))throw oe;if(o)return;d=s(this,B)[g]=new te,u!==""&&f(d,J,n.varIndex++)}!o&&u!==""&&r.push([u,s(d,J)])}else if(d=s(this,B)[i],!d){if(Object.keys(s(this,B)).some(u=>u.length>1&&u!==me&&u!==pe))throw oe;if(o)return;d=s(this,B)[i]=new te}d.insert(c,a,r,n,o)}buildRegExpStr(){const a=Object.keys(s(this,B)).sort(qt).map(r=>{const n=s(this,B)[r];return(typeof s(n,J)=="number"?`(${r})@${s(n,J)}`:_t.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof s(this,V)=="number"&&a.unshift(`#${s(this,V)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},V=new WeakMap,J=new WeakMap,B=new WeakMap,te),Le,Ie,Xe,Wt=(Xe=class{constructor(){m(this,Le,{varIndex:0});m(this,Ie,new Zt)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let c=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return n[i]=[d,l],i++,c=!0,d}),!c)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[c]=n[i];for(let l=o.length-1;l>=0;l--)if(o[l].indexOf(c)!==-1){o[l]=o[l].replace(c,n[i][1]);break}}return s(this,Ie).insert(o,t,r,s(this,Le),a),r}buildRegExp(){let e=s(this,Ie).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,i)=>o!==void 0?(a[++t]=Number(o),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},Le=new WeakMap,Ie=new WeakMap,Xe),Yt=[/^$/,[],Object.create(null)],Re=Object.create(null);function ft(e){return Re[e]??(Re[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Kt(){Re=Object.create(null)}function Xt(e){var d;const t=new Wt,a=[];if(e.length===0)return Yt;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,g],[p,x])=>u?1:p?-1:g.length-x.length),n=Object.create(null);for(let u=0,g=-1,p=r.length;u<p;u++){const[x,k,z]=r[u];x?n[k]=[z.map(([C])=>[C,Object.create(null)]),gt]:g++;let v;try{v=t.insert(k,g,x)}catch(C){throw C===oe?new ct(k):C}x||(a[g]=z.map(([C,N])=>{const Te=Object.create(null);for(N-=1;N>=0;N--){const[Ce,H]=v[N];Te[Ce]=H}return[C,Te]}))}const[o,i,c]=t.buildRegExp();for(let u=0,g=a.length;u<g;u++)for(let p=0,x=a[u].length;p<x;p++){const k=(d=a[u][p])==null?void 0:d[1];if(!k)continue;const z=Object.keys(k);for(let v=0,C=z.length;v<C;v++)k[z[v]]=c[k[z[v]]]}const l=[];for(const u in i)l[u]=a[i[u]];return[o,l,n]}function ae(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ft(a).test(t))return[...e[a]]}}var _,q,Be,ht,Ve,Vt=(Ve=class{constructor(){m(this,Be);h(this,"name","RegExpRouter");m(this,_);m(this,q);h(this,"match",Gt);f(this,_,{[y]:Object.create(null)}),f(this,q,{[y]:Object.create(null)})}add(e,t,a){var c;const r=s(this,_),n=s(this,q);if(!r||!n)throw new Error(dt);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[y]).forEach(d=>{l[e][d]=[...l[y][d]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ft(t);e===y?Object.keys(r).forEach(d=>{var u;(u=r[d])[t]||(u[t]=ae(r[d],t)||ae(r[y],t)||[])}):(c=r[e])[t]||(c[t]=ae(r[e],t)||ae(r[y],t)||[]),Object.keys(r).forEach(d=>{(e===y||e===d)&&Object.keys(r[d]).forEach(u=>{l.test(u)&&r[d][u].push([a,o])})}),Object.keys(n).forEach(d=>{(e===y||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([a,o]))});return}const i=at(t)||[t];for(let l=0,d=i.length;l<d;l++){const u=i[l];Object.keys(n).forEach(g=>{var p;(e===y||e===g)&&((p=n[g])[u]||(p[u]=[...ae(r[g],u)||ae(r[y],u)||[]]),n[g][u].push([a,o-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(s(this,q)).concat(Object.keys(s(this,_))).forEach(t=>{e[t]||(e[t]=b(this,Be,ht).call(this,t))}),f(this,_,f(this,q,void 0)),Kt(),e}},_=new WeakMap,q=new WeakMap,Be=new WeakSet,ht=function(e){const t=[];let a=e===y;return[s(this,_),s(this,q)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(o=>[o,r[e][o]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==y&&t.push(...Object.keys(r[y]).map(o=>[o,r[y][o]]))}),a?Xt(t):null},Ve),Z,F,Je,Jt=(Je=class{constructor(e){h(this,"name","SmartRouter");m(this,Z,[]);m(this,F,[]);f(this,Z,e.routers)}add(e,t,a){if(!s(this,F))throw new Error(dt);s(this,F).push([e,t,a])}match(e,t){if(!s(this,F))throw new Error("Fatal error");const a=s(this,Z),r=s(this,F),n=a.length;let o=0,i;for(;o<n;o++){const c=a[o];try{for(let l=0,d=r.length;l<d;l++)c.add(...r[l]);i=c.match(e,t)}catch(l){if(l instanceof ct)continue;throw l}this.match=c.match.bind(c),f(this,Z,[c]),f(this,F,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(s(this,F)||s(this,Z).length!==1)throw new Error("No active router has been determined yet.");return s(this,Z)[0]}},Z=new WeakMap,F=new WeakMap,Je),he=Object.create(null),W,T,Q,ue,I,j,K,ge,Qt=(ge=class{constructor(t,a,r){m(this,j);m(this,W);m(this,T);m(this,Q);m(this,ue,0);m(this,I,he);if(f(this,T,r||Object.create(null)),f(this,W,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},f(this,W,[n])}f(this,Q,[])}insert(t,a,r){f(this,ue,++$e(this,ue)._);let n=this;const o=kt(a),i=[];for(let c=0,l=o.length;c<l;c++){const d=o[c],u=o[c+1],g=Lt(d,u),p=Array.isArray(g)?g[0]:d;if(p in s(n,T)){n=s(n,T)[p],g&&i.push(g[1]);continue}s(n,T)[p]=new ge,g&&(s(n,Q).push(g),i.push(g[1])),n=s(n,T)[p]}return s(n,W).push({[t]:{handler:r,possibleKeys:i.filter((c,l,d)=>d.indexOf(c)===l),score:s(this,ue)}}),n}search(t,a){var l;const r=[];f(this,I,he);let o=[this];const i=et(a),c=[];for(let d=0,u=i.length;d<u;d++){const g=i[d],p=d===u-1,x=[];for(let k=0,z=o.length;k<z;k++){const v=o[k],C=s(v,T)[g];C&&(f(C,I,s(v,I)),p?(s(C,T)["*"]&&r.push(...b(this,j,K).call(this,s(C,T)["*"],t,s(v,I))),r.push(...b(this,j,K).call(this,C,t,s(v,I)))):x.push(C));for(let N=0,Te=s(v,Q).length;N<Te;N++){const Ce=s(v,Q)[N],H=s(v,I)===he?{}:{...s(v,I)};if(Ce==="*"){const M=s(v,T)["*"];M&&(r.push(...b(this,j,K).call(this,M,t,s(v,I))),f(M,I,H),x.push(M));continue}const[bt,Ne,fe]=Ce;if(!g&&!(fe instanceof RegExp))continue;const D=s(v,T)[bt],xt=i.slice(d).join("/");if(fe instanceof RegExp){const M=fe.exec(xt);if(M){if(H[Ne]=M[0],r.push(...b(this,j,K).call(this,D,t,s(v,I),H)),Object.keys(s(D,T)).length){f(D,I,H);const He=((l=M[0].match(/\//))==null?void 0:l.length)??0;(c[He]||(c[He]=[])).push(D)}continue}}(fe===!0||fe.test(g))&&(H[Ne]=g,p?(r.push(...b(this,j,K).call(this,D,t,H,s(v,I))),s(D,T)["*"]&&r.push(...b(this,j,K).call(this,s(D,T)["*"],t,H,s(v,I)))):(f(D,I,H),x.push(D)))}}o=x.concat(c.shift()??[])}return r.length>1&&r.sort((d,u)=>d.score-u.score),[r.map(({handler:d,params:u})=>[d,u])]}},W=new WeakMap,T=new WeakMap,Q=new WeakMap,ue=new WeakMap,I=new WeakMap,j=new WeakSet,K=function(t,a,r,n){const o=[];for(let i=0,c=s(t,W).length;i<c;i++){const l=s(t,W)[i],d=l[a]||l[y],u={};if(d!==void 0&&(d.params=Object.create(null),o.push(d),r!==he||n&&n!==he))for(let g=0,p=d.possibleKeys.length;g<p;g++){const x=d.possibleKeys[g],k=u[d.score];d.params[x]=n!=null&&n[x]&&!k?n[x]:r[x]??(n==null?void 0:n[x]),u[d.score]=!0}}return o},ge),ee,Qe,ea=(Qe=class{constructor(){h(this,"name","TrieRouter");m(this,ee);f(this,ee,new Qt)}add(e,t,a){const r=at(t);if(r){for(let n=0,o=r.length;n<o;n++)s(this,ee).insert(e,r[n],a);return}s(this,ee).insert(e,t,a)}match(e,t){return s(this,ee).search(e,t)}},ee=new WeakMap,Qe),mt=class extends $t{constructor(e={}){super(e),this.router=e.router??new Jt({routers:[new Vt,new ea]})}},ta=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(o=>typeof o=="string"?o==="*"?()=>o:i=>o===i?i:null:typeof o=="function"?o:i=>o.includes(i)?i:null)(a.origin),n=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(a.allowMethods);return async function(i,c){var u;function l(g,p){i.res.headers.set(g,p)}const d=await r(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const g=await n(i.req.header("origin")||"",i);g.length&&l("Access-Control-Allow-Methods",g.join(","));let p=a.allowHeaders;if(!(p!=null&&p.length)){const x=i.req.header("Access-Control-Request-Headers");x&&(p=x.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await c(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};const E=new mt;E.use("/api/*",ta());const ze="cf2a50987a92a698e89d5efeb80cde82",Fe={face:"https://iili.io/fM9hV6B.png",outfit:"https://iili.io/fM99P3l.png",logo:"https://iili.io/fEiEfUB.png"};E.get("/api/bases",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=await fetch("https://api.airtable.com/v0/meta/bases",{headers:{Authorization:`Bearer ${t}`}});return e.json(await a.json())});E.get("/api/bases/:baseId/tables",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.param("baseId"),r=await fetch(`https://api.airtable.com/v0/meta/bases/${a}/tables`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await r.json())});E.get("/api/records",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.query("filter")||"";if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);let o=`https://api.airtable.com/v0/${a}/${r}?pageSize=50`;n&&n!=="all"&&(o+=`&filterByFormula={Status}='${n}'`);const i=await fetch(o,{headers:{Authorization:`Bearer ${t}`}});return e.json(await i.json())});E.get("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id");if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const o=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await o.json())});E.patch("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id"),o=await e.req.json();if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const i=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{method:"PATCH",headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({fields:o})});return e.json(await i.json())});E.post("/api/generate-image",async e=>{const{prompt:t,imageUrls:a,aspectRatio:r}=await e.req.json(),n={model:"google/nano-banana",input:{prompt:t,image_urls:a||[Fe.face,Fe.outfit,Fe.logo],image_size:r||"16:9",output_format:"png"}};console.log("KieAI Nano Banana Request:",JSON.stringify(n,null,2));const o=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${ze}`,"Content-Type":"application/json"},body:JSON.stringify(n)});return e.json(await o.json())});const Ze={"16:9":"https://iili.io/fk9ypqB.png","9:16":"https://iili.io/fk9yy0P.png","1:1":"https://iili.io/fkH99g1.png"};E.post("/api/generate-image-ideogram",async e=>{const{prompt:t,imageUrl:a,aspectRatio:r}=await e.req.json(),n=Ze[r]||Ze["16:9"],o={model:"ideogram/character-edit",input:{prompt:t,image_url:a,mask_url:n,rendering_speed:"BALANCED",style:"AUTO",expand_prompt:!1,num_images:"1"}};console.log("Ideogram character-edit Request (text overlay):",JSON.stringify(o,null,2));const i=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${ze}`,"Content-Type":"application/json"},body:JSON.stringify(o)});return e.json(await i.json())});E.get("/api/task-status/:taskId",async e=>{const t=e.req.param("taskId"),a=await fetch(`https://api.kie.ai/api/v1/jobs/recordInfo?taskId=${t}`,{headers:{Authorization:`Bearer ${ze}`}});return e.json(await a.json())});E.post("/api/upload-image",async e=>{const{base64Image:t}=await e.req.json(),a=new FormData;a.append("key","6d207e02198a847aa98d0a2a901485a5"),a.append("action","upload"),a.append("source",t),a.append("format","json");const r=await fetch("https://freeimage.host/api/1/upload",{method:"POST",body:a});return e.json(await r.json())});E.post("/api/proxy-image",async e=>{try{const{imageUrl:t}=await e.req.json();if(!t)return e.json({error:"Missing imageUrl"},400);const a=await fetch(t);if(!a.ok)return e.json({error:"Failed to fetch image: "+a.status},500);const r=await a.arrayBuffer(),n=new Uint8Array(r);let o="";for(let l=0;l<n.length;l++)o+=String.fromCharCode(n[l]);const i=btoa(o),c=a.headers.get("content-type")||"image/png";return e.json({success:!0,base64:i,contentType:c,dataUrl:"data:"+c+";base64,"+i})}catch(t){return e.json({error:"Proxy error: "+t.message},500)}});const aa={crypto:{baseId:"appgyL5gKf8rjaJPv",tableId:"tblZwA0JCNPeORaGi",fieldMap:{url:"sourceURL",title:"sourceHeadline",notes:"sourceSummary",platforms:"socialChannels",status:"Status",statusValue:"Needs Approval"}},ai:{baseId:"appgyL5gKf8rjaJPv",tableId:"tblSXrbwYXTQC7D2u",fieldMap:{url:"sourceURL",title:"sourceHeadline",notes:"sourceSummary",platforms:"socialChannels",status:"Status",statusValue:"Needs Approval"}},general:{baseId:"appQggEi0kxkoSmLn",tableId:"tblhAFDUnMcdO8DLk",fieldMap:{url:"Video URL",title:"Video Title",notes:"Notes",platforms:"Platforms",status:"Status",statusValue:"Pending Review"}}},ra=["Twitter","LinkedIn","Blog","Instagram","Facebook","Avatar"],na="patzmYCtUSKROFbsw.ebdd70b78b2f422fd5a6da1aa867be11f690a795117c9e13d9d4747708018921";E.post("/api/save",async e=>{try{const{url:t,title:a,notes:r,platforms:n,topic:o}=await e.req.json();if(!t)return e.json({success:!1,error:"URL is required"},400);const i=o||"general",c=aa[i];if(!c)return e.json({success:!1,error:"Invalid topic. Use: crypto, ai, or general"},400);const l=c.fieldMap,d={};if(d[l.url]=t,d[l.title]=a||"",d[l.status]=l.statusValue,r&&(d[l.notes]=r),n&&n.length>0)if(i==="crypto"||i==="ai"){const p=n.filter(x=>ra.includes(x));p.length>0&&(d[l.platforms]=p)}else d[l.platforms]=n;i==="general"&&(d["Created Date"]=new Date().toISOString());const g=await(await fetch(`https://api.airtable.com/v0/${c.baseId}/${c.tableId}`,{method:"POST",headers:{Authorization:`Bearer ${na}`,"Content-Type":"application/json"},body:JSON.stringify({fields:d})})).json();return g.error?(console.error("Airtable error:",g.error),e.json({success:!1,error:g.error.message||"Airtable error"},500)):e.json({success:!0,record:g,topic:i,table:i==="general"?"Content Pipeline":i==="crypto"?"Social Posts":"Social Posts - AI"})}catch(t){return console.error("Save error:",t),e.json({success:!1,error:t.message||"Server error"},500)}});E.get("/api/topics",e=>e.json({topics:[{id:"crypto",label:"🪙 Crypto News",description:"Save to 5th Ave Crypto pipeline"},{id:"ai",label:"🤖 AI News",description:"Save to 5th Ave AI pipeline"},{id:"general",label:"📋 General Pipeline",description:"Save to Content Pipeline"}]}));E.get("/",e=>e.html(`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body class="text-gray-100">
  ...
  `));const We=new mt,oa=Object.assign({"/src/index.tsx":E});let pt=!1;for(const[,e]of Object.entries(oa))e&&(We.route("/",e),We.notFound(e.notFoundHandler),pt=!0);if(!pt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{We as default};
