...
- Text must be crisp, clear, and professional\`;
  ...
  `));const Ze=new ht,ta=Object.assign({"/src/index.tsx":k});let mt=!1;for(const[,e]of Object.entries(ta))e&&(Ze.route("/",e),Ze.notFound(e.notFoundHandler),mt=!0);if(!mt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Ze as default};
