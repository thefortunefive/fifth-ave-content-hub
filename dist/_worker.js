var vt=Object.defineProperty;var Ne=e=>{throw TypeError(e)};var yt=(e,t,a)=>t in e?vt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var h=(e,t,a)=>yt(e,typeof t!="symbol"?t+"":t,a),De=(e,t,a)=>t.has(e)||Ne("Cannot "+a);var s=(e,t,a)=>(De(e,t,"read from private field"),a?a.call(e):t.get(e)),m=(e,t,a)=>t.has(e)?Ne("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),f=(e,t,a,n)=>(De(e,t,"write to private field"),n?n.call(e,a):t.set(e,a),a),b=(e,t,a)=>(De(e,t,"access private method"),a);var $e=(e,t,a,n)=>({set _(r){f(e,t,r,a)},get _(){return s(e,t,n)}});var Ge=(e,t,a)=>(n,r)=>{let o=-1;return i(0);async function i(c){if(c<=o)throw new Error("next() called multiple times");o=c;let l,d=!1,u;if(e[c]?(u=e[c][0][0],n.req.routeIndex=c):u=c===e.length&&r||void 0,u)try{l=await u(n,()=>i(c+1))}catch(g){if(g instanceof Error&&t)n.error=g,l=await t(g,n),d=!0;else throw g}else n.finalized===!1&&a&&(l=await a(n));return l&&(n.finalized===!1||d)&&(n.res=l),n}},wt=Symbol(),It=async(e,t=Object.create(null))=>{const{all:a=!1,dot:n=!1}=t,o=(e instanceof ot?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?Tt(e,{all:a,dot:n}):{}};async function Tt(e,t){const a=await e.formData();return a?Ct(a,t):{}}function Ct(e,t){const a=Object.create(null);return e.forEach((n,r)=>{t.all||r.endsWith("[]")?Et(a,r,n):a[r]=n}),t.dot&&Object.entries(a).forEach(([n,r])=>{n.includes(".")&&(St(a,n,r),delete a[n])}),a}var Et=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},St=(e,t,a)=>{let n=e;const r=t.split(".");r.forEach((o,i)=>{i===r.length-1?n[o]=a:((!n[o]||typeof n[o]!="object"||Array.isArray(n[o])||n[o]instanceof File)&&(n[o]=Object.create(null)),n=n[o])})},et=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},kt=e=>{const{groups:t,path:a}=Rt(e),n=et(a);return Lt(n,t)},Rt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,n)=>{const r=`@${n}`;return t.push([r,a]),r}),{groups:t,path:e}},Lt=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[n]=t[a];for(let r=e.length-1;r>=0;r--)if(e[r].includes(n)){e[r]=e[r].replace(n,t[a][1]);break}}return e},Ee={},At=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const n=`${e}#${t}`;return Ee[n]||(a[2]?Ee[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Ee[n]=[e,a[1],!0]),Ee[n]}return null},Ue=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Bt=e=>Ue(e,decodeURI),tt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let n=a;for(;n<t.length;n++){const r=t.charCodeAt(n);if(r===37){const o=t.indexOf("?",n),i=t.slice(a,o===-1?void 0:o);return Bt(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(r===63)break}return t.slice(a,n)},Ht=e=>{const t=tt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ne=(e,t,...a)=>(a.length&&(t=ne(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),at=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let n="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))n+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){a.length===0&&n===""?a.push("/"):a.push(n);const o=r.replace("?","");n+="/"+o,a.push(n)}else n+="/"+r}),a.filter((r,o,i)=>i.indexOf(r)===o)},Oe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ue(e,rt):e):e,nt=(e,t,a)=>{let n;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const c=e.charCodeAt(i+t.length+1);if(c===61){const l=i+t.length+2,d=e.indexOf("&",l);return Oe(e.slice(l,d===-1?void 0:d))}else if(c==38||isNaN(c))return"";i=e.indexOf(`&${t}`,i+1)}if(n=/[%+]/.test(e),!n)return}const r={};n??(n=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const i=e.indexOf("&",o+1);let c=e.indexOf("=",o);c>i&&i!==-1&&(c=-1);let l=e.slice(o+1,c===-1?i===-1?void 0:i:c);if(n&&(l=Oe(l)),o=i,l==="")continue;let d;c===-1?d="":(d=e.slice(c+1,i===-1?void 0:i),n&&(d=Oe(d))),a?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(d)):r[l]??(r[l]=d)}return t?r[t]:r},Dt=nt,Ot=(e,t)=>nt(e,t,!0),rt=decodeURIComponent,_e=e=>Ue(e,rt),ie,R,U,it,st,je,$,Ye,ot=(Ye=class{constructor(e,t="/",a=[[]]){m(this,U);h(this,"raw");m(this,ie);m(this,R);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});m(this,$,e=>{const{bodyCache:t,raw:a}=this,n=t[e];if(n)return n;const r=Object.keys(t)[0];return r?t[r].then(o=>(r==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,f(this,R,a),f(this,ie,{})}param(e){return e?b(this,U,it).call(this,e):b(this,U,st).call(this)}query(e){return Dt(this.url,e)}queries(e){return Ot(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,n)=>{t[n]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await It(this,e))}json(){return s(this,$).call(this,"text").then(e=>JSON.parse(e))}text(){return s(this,$).call(this,"text")}arrayBuffer(){return s(this,$).call(this,"arrayBuffer")}blob(){return s(this,$).call(this,"blob")}formData(){return s(this,$).call(this,"formData")}addValidatedData(e,t){s(this,ie)[e]=t}valid(e){return s(this,ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[wt](){return s(this,R)}get matchedRoutes(){return s(this,R)[0].map(([[,e]])=>e)}get routePath(){return s(this,R)[0].map(([[,e]])=>e)[this.routeIndex].path}},ie=new WeakMap,R=new WeakMap,U=new WeakSet,it=function(e){const t=s(this,R)[0][this.routeIndex][1][e],a=b(this,U,je).call(this,t);return a&&/\%/.test(a)?_e(a):a},st=function(){const e={},t=Object.keys(s(this,R)[0][this.routeIndex][1]);for(const a of t){const n=b(this,U,je).call(this,s(this,R)[0][this.routeIndex][1][a]);n!==void 0&&(e[a]=/\%/.test(n)?_e(n):n)}return e},je=function(e){return s(this,R)[1]?s(this,R)[1][e]:e},$=new WeakMap,Ye),Ft={Stringify:1},lt=async(e,t,a,n,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(r?r[0]+=e:r=[e],Promise.all(o.map(c=>c({phase:t,buffer:r,context:n}))).then(c=>Promise.all(c.filter(Boolean).map(l=>lt(l,t,!1,n,r))).then(()=>r[0]))):Promise.resolve(e)},Pt="text/plain; charset=UTF-8",Fe=(e,t)=>({"Content-Type":e,...t}),be,xe,O,se,F,E,ve,le,de,X,ye,we,G,re,Ke,jt=(Ke=class{constructor(e,t){m(this,G);m(this,be);m(this,xe);h(this,"env",{});m(this,O);h(this,"finalized",!1);h(this,"error");m(this,se);m(this,F);m(this,E);m(this,ve);m(this,le);m(this,de);m(this,X);m(this,ye);m(this,we);h(this,"render",(...e)=>(s(this,le)??f(this,le,t=>this.html(t)),s(this,le).call(this,...e)));h(this,"setLayout",e=>f(this,ve,e));h(this,"getLayout",()=>s(this,ve));h(this,"setRenderer",e=>{f(this,le,e)});h(this,"header",(e,t,a)=>{this.finalized&&f(this,E,new Response(s(this,E).body,s(this,E)));const n=s(this,E)?s(this,E).headers:s(this,X)??f(this,X,new Headers);t===void 0?n.delete(e):a!=null&&a.append?n.append(e,t):n.set(e,t)});h(this,"status",e=>{f(this,se,e)});h(this,"set",(e,t)=>{s(this,O)??f(this,O,new Map),s(this,O).set(e,t)});h(this,"get",e=>s(this,O)?s(this,O).get(e):void 0);h(this,"newResponse",(...e)=>b(this,G,re).call(this,...e));h(this,"body",(e,t,a)=>b(this,G,re).call(this,e,t,a));h(this,"text",(e,t,a)=>!s(this,X)&&!s(this,se)&&!t&&!a&&!this.finalized?new Response(e):b(this,G,re).call(this,e,t,Fe(Pt,a)));h(this,"json",(e,t,a)=>b(this,G,re).call(this,JSON.stringify(e),t,Fe("application/json",a)));h(this,"html",(e,t,a)=>{const n=r=>b(this,G,re).call(this,r,t,Fe("text/html; charset=UTF-8",a));return typeof e=="object"?lt(e,Ft.Stringify,!1,{}).then(n):n(e)});h(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});h(this,"notFound",()=>(s(this,de)??f(this,de,()=>new Response),s(this,de).call(this,this)));f(this,be,e),t&&(f(this,F,t.executionCtx),this.env=t.env,f(this,de,t.notFoundHandler),f(this,we,t.path),f(this,ye,t.matchResult))}get req(){return s(this,xe)??f(this,xe,new ot(s(this,be),s(this,we),s(this,ye))),s(this,xe)}get event(){if(s(this,F)&&"respondWith"in s(this,F))return s(this,F);throw Error("This context has no FetchEvent")}get executionCtx(){if(s(this,F))return s(this,F);throw Error("This context has no ExecutionContext")}get res(){return s(this,E)||f(this,E,new Response(null,{headers:s(this,X)??f(this,X,new Headers)}))}set res(e){if(s(this,E)&&e){e=new Response(e.body,e);for(const[t,a]of s(this,E).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=s(this,E).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of n)e.headers.append("set-cookie",r)}else e.headers.set(t,a)}f(this,E,e),this.finalized=!0}get var(){return s(this,O)?Object.fromEntries(s(this,O)):{}}},be=new WeakMap,xe=new WeakMap,O=new WeakMap,se=new WeakMap,F=new WeakMap,E=new WeakMap,ve=new WeakMap,le=new WeakMap,de=new WeakMap,X=new WeakMap,ye=new WeakMap,we=new WeakMap,G=new WeakSet,re=function(e,t,a){const n=s(this,E)?new Headers(s(this,E).headers):s(this,X)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,c]of o)i.toLowerCase()==="set-cookie"?n.append(i,c):n.set(i,c)}if(a)for(const[o,i]of Object.entries(a))if(typeof i=="string")n.set(o,i);else{n.delete(o);for(const c of i)n.append(o,c)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??s(this,se);return new Response(e,{status:r,headers:n})},Ke),y="ALL",Ut="all",zt=["get","post","put","delete","options","patch"],dt="Can not add a route since the matcher is already built.",ct=class extends Error{},Mt="__COMPOSED_HANDLER",Nt=e=>e.text("404 Not Found",404),qe=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},L,w,ut,A,Y,Se,ke,ce,$t=(ce=class{constructor(t={}){m(this,w);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");m(this,L,"/");h(this,"routes",[]);m(this,A,Nt);h(this,"errorHandler",qe);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(f(this,A,t),this));h(this,"fetch",(t,...a)=>b(this,w,ke).call(this,t,a[1],a[0],t.method));h(this,"request",(t,a,n,r)=>t instanceof Request?this.fetch(a?new Request(t,a):t,n,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ne("/",t)}`,a),n,r)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,w,ke).call(this,t.request,t,void 0,t.request.method))})});[...zt,Ut].forEach(o=>{this[o]=(i,...c)=>(typeof i=="string"?f(this,L,i):b(this,w,Y).call(this,o,s(this,L),i),c.forEach(l=>{b(this,w,Y).call(this,o,s(this,L),l)}),this)}),this.on=(o,i,...c)=>{for(const l of[i].flat()){f(this,L,l);for(const d of[o].flat())c.map(u=>{b(this,w,Y).call(this,d.toUpperCase(),s(this,L),u)})}return this},this.use=(o,...i)=>(typeof o=="string"?f(this,L,o):(f(this,L,"*"),i.unshift(o)),i.forEach(c=>{b(this,w,Y).call(this,y,s(this,L),c)}),this);const{strict:n,...r}=t;Object.assign(this,r),this.getPath=n??!0?t.getPath??tt:Ht}route(t,a){const n=this.basePath(t);return a.routes.map(r=>{var i;let o;a.errorHandler===qe?o=r.handler:(o=async(c,l)=>(await Ge([],a.errorHandler)(c,()=>r.handler(c,l))).res,o[Mt]=r.handler),b(i=n,w,Y).call(i,r.method,r.path,o)}),this}basePath(t){const a=b(this,w,ut).call(this);return a._basePath=ne(this._basePath,t),a}mount(t,a,n){let r,o;n&&(typeof n=="function"?o=n:(o=n.optionHandler,n.replaceRequest===!1?r=l=>l:r=n.replaceRequest));const i=o?l=>{const d=o(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};r||(r=(()=>{const l=ne(this._basePath,t),d=l==="/"?0:l.length;return u=>{const g=new URL(u.url);return g.pathname=g.pathname.slice(d)||"/",new Request(g,u)}})());const c=async(l,d)=>{const u=await a(r(l.req.raw),...i(l));if(u)return u;await d()};return b(this,w,Y).call(this,y,ne(t,"*"),c),this}},L=new WeakMap,w=new WeakSet,ut=function(){const t=new ce({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,A,s(this,A)),t.routes=this.routes,t},A=new WeakMap,Y=function(t,a,n){t=t.toUpperCase(),a=ne(this._basePath,a);const r={basePath:this._basePath,path:a,method:t,handler:n};this.router.add(t,a,[n,r]),this.routes.push(r)},Se=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ke=function(t,a,n,r){if(r==="HEAD")return(async()=>new Response(null,await b(this,w,ke).call(this,t,a,n,"GET")))();const o=this.getPath(t,{env:n}),i=this.router.match(r,o),c=new jt(t,{path:o,matchResult:i,env:n,executionCtx:a,notFoundHandler:s(this,A)});if(i[0].length===1){let d;try{d=i[0][0][0][0](c,async()=>{c.res=await s(this,A).call(this,c)})}catch(u){return b(this,w,Se).call(this,u,c)}return d instanceof Promise?d.then(u=>u||(c.finalized?c.res:s(this,A).call(this,c))).catch(u=>b(this,w,Se).call(this,u,c)):d??s(this,A).call(this,c)}const l=Ge(i[0],this.errorHandler,s(this,A));return(async()=>{try{const d=await l(c);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return b(this,w,Se).call(this,d,c)}})()},ce),gt=[];function Gt(e,t){const a=this.buildAllMatchers(),n=(r,o)=>{const i=a[r]||a[y],c=i[2][o];if(c)return c;const l=o.match(i[0]);if(!l)return[[],gt];const d=l.indexOf("",1);return[i[1][d],l]};return this.match=n,n(e,t)}var Le="[^/]+",me=".*",pe="(?:|/.*)",oe=Symbol(),_t=new Set(".\\+*[^]$()");function qt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===me||e===pe?1:t===me||t===pe?-1:e===Le?1:t===Le?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var J,V,B,te,Zt=(te=class{constructor(){m(this,J);m(this,V);m(this,B,Object.create(null))}insert(t,a,n,r,o){if(t.length===0){if(s(this,J)!==void 0)throw oe;if(o)return;f(this,J,a);return}const[i,...c]=t,l=i==="*"?c.length===0?["","",me]:["","",Le]:i==="/*"?["","",pe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let g=l[2]||Le;if(u&&l[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw oe;if(d=s(this,B)[g],!d){if(Object.keys(s(this,B)).some(p=>p!==me&&p!==pe))throw oe;if(o)return;d=s(this,B)[g]=new te,u!==""&&f(d,V,r.varIndex++)}!o&&u!==""&&n.push([u,s(d,V)])}else if(d=s(this,B)[i],!d){if(Object.keys(s(this,B)).some(u=>u.length>1&&u!==me&&u!==pe))throw oe;if(o)return;d=s(this,B)[i]=new te}d.insert(c,a,n,r,o)}buildRegExpStr(){const a=Object.keys(s(this,B)).sort(qt).map(n=>{const r=s(this,B)[n];return(typeof s(r,V)=="number"?`(${n})@${s(r,V)}`:_t.has(n)?`\\${n}`:n)+r.buildRegExpStr()});return typeof s(this,J)=="number"&&a.unshift(`#${s(this,J)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},J=new WeakMap,V=new WeakMap,B=new WeakMap,te),Ae,Ie,Xe,Wt=(Xe=class{constructor(){m(this,Ae,{varIndex:0});m(this,Ie,new Zt)}insert(e,t,a){const n=[],r=[];for(let i=0;;){let c=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return r[i]=[d,l],i++,c=!0,d}),!c)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[c]=r[i];for(let l=o.length-1;l>=0;l--)if(o[l].indexOf(c)!==-1){o[l]=o[l].replace(c,r[i][1]);break}}return s(this,Ie).insert(o,t,n,s(this,Ae),a),n}buildRegExp(){let e=s(this,Ie).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,o,i)=>o!==void 0?(a[++t]=Number(o),"$()"):(i!==void 0&&(n[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,n]}},Ae=new WeakMap,Ie=new WeakMap,Xe),Yt=[/^$/,[],Object.create(null)],Re=Object.create(null);function ft(e){return Re[e]??(Re[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Kt(){Re=Object.create(null)}function Xt(e){var d;const t=new Wt,a=[];if(e.length===0)return Yt;const n=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,g],[p,v])=>u?1:p?-1:g.length-v.length),r=Object.create(null);for(let u=0,g=-1,p=n.length;u<p;u++){const[v,S,z]=n[u];v?r[S]=[z.map(([C])=>[C,Object.create(null)]),gt]:g++;let x;try{x=t.insert(S,g,v)}catch(C){throw C===oe?new ct(S):C}v||(a[g]=z.map(([C,M])=>{const Te=Object.create(null);for(M-=1;M>=0;M--){const[Ce,H]=x[M];Te[Ce]=H}return[C,Te]}))}const[o,i,c]=t.buildRegExp();for(let u=0,g=a.length;u<g;u++)for(let p=0,v=a[u].length;p<v;p++){const S=(d=a[u][p])==null?void 0:d[1];if(!S)continue;const z=Object.keys(S);for(let x=0,C=z.length;x<C;x++)S[z[x]]=c[S[z[x]]]}const l=[];for(const u in i)l[u]=a[i[u]];return[o,l,r]}function ae(e,t){if(e){for(const a of Object.keys(e).sort((n,r)=>r.length-n.length))if(ft(a).test(t))return[...e[a]]}}var _,q,Be,ht,Je,Jt=(Je=class{constructor(){m(this,Be);h(this,"name","RegExpRouter");m(this,_);m(this,q);h(this,"match",Gt);f(this,_,{[y]:Object.create(null)}),f(this,q,{[y]:Object.create(null)})}add(e,t,a){var c;const n=s(this,_),r=s(this,q);if(!n||!r)throw new Error(dt);n[e]||[n,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[y]).forEach(d=>{l[e][d]=[...l[y][d]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ft(t);e===y?Object.keys(n).forEach(d=>{var u;(u=n[d])[t]||(u[t]=ae(n[d],t)||ae(n[y],t)||[])}):(c=n[e])[t]||(c[t]=ae(n[e],t)||ae(n[y],t)||[]),Object.keys(n).forEach(d=>{(e===y||e===d)&&Object.keys(n[d]).forEach(u=>{l.test(u)&&n[d][u].push([a,o])})}),Object.keys(r).forEach(d=>{(e===y||e===d)&&Object.keys(r[d]).forEach(u=>l.test(u)&&r[d][u].push([a,o]))});return}const i=at(t)||[t];for(let l=0,d=i.length;l<d;l++){const u=i[l];Object.keys(r).forEach(g=>{var p;(e===y||e===g)&&((p=r[g])[u]||(p[u]=[...ae(n[g],u)||ae(n[y],u)||[]]),r[g][u].push([a,o-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(s(this,q)).concat(Object.keys(s(this,_))).forEach(t=>{e[t]||(e[t]=b(this,Be,ht).call(this,t))}),f(this,_,f(this,q,void 0)),Kt(),e}},_=new WeakMap,q=new WeakMap,Be=new WeakSet,ht=function(e){const t=[];let a=e===y;return[s(this,_),s(this,q)].forEach(n=>{const r=n[e]?Object.keys(n[e]).map(o=>[o,n[e][o]]):[];r.length!==0?(a||(a=!0),t.push(...r)):e!==y&&t.push(...Object.keys(n[y]).map(o=>[o,n[y][o]]))}),a?Xt(t):null},Je),Z,P,Ve,Vt=(Ve=class{constructor(e){h(this,"name","SmartRouter");m(this,Z,[]);m(this,P,[]);f(this,Z,e.routers)}add(e,t,a){if(!s(this,P))throw new Error(dt);s(this,P).push([e,t,a])}match(e,t){if(!s(this,P))throw new Error("Fatal error");const a=s(this,Z),n=s(this,P),r=a.length;let o=0,i;for(;o<r;o++){const c=a[o];try{for(let l=0,d=n.length;l<d;l++)c.add(...n[l]);i=c.match(e,t)}catch(l){if(l instanceof ct)continue;throw l}this.match=c.match.bind(c),f(this,Z,[c]),f(this,P,void 0);break}if(o===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(s(this,P)||s(this,Z).length!==1)throw new Error("No active router has been determined yet.");return s(this,Z)[0]}},Z=new WeakMap,P=new WeakMap,Ve),he=Object.create(null),W,T,Q,ue,I,j,K,ge,Qt=(ge=class{constructor(t,a,n){m(this,j);m(this,W);m(this,T);m(this,Q);m(this,ue,0);m(this,I,he);if(f(this,T,n||Object.create(null)),f(this,W,[]),t&&a){const r=Object.create(null);r[t]={handler:a,possibleKeys:[],score:0},f(this,W,[r])}f(this,Q,[])}insert(t,a,n){f(this,ue,++$e(this,ue)._);let r=this;const o=kt(a),i=[];for(let c=0,l=o.length;c<l;c++){const d=o[c],u=o[c+1],g=At(d,u),p=Array.isArray(g)?g[0]:d;if(p in s(r,T)){r=s(r,T)[p],g&&i.push(g[1]);continue}s(r,T)[p]=new ge,g&&(s(r,Q).push(g),i.push(g[1])),r=s(r,T)[p]}return s(r,W).push({[t]:{handler:n,possibleKeys:i.filter((c,l,d)=>d.indexOf(c)===l),score:s(this,ue)}}),r}search(t,a){var l;const n=[];f(this,I,he);let o=[this];const i=et(a),c=[];for(let d=0,u=i.length;d<u;d++){const g=i[d],p=d===u-1,v=[];for(let S=0,z=o.length;S<z;S++){const x=o[S],C=s(x,T)[g];C&&(f(C,I,s(x,I)),p?(s(C,T)["*"]&&n.push(...b(this,j,K).call(this,s(C,T)["*"],t,s(x,I))),n.push(...b(this,j,K).call(this,C,t,s(x,I)))):v.push(C));for(let M=0,Te=s(x,Q).length;M<Te;M++){const Ce=s(x,Q)[M],H=s(x,I)===he?{}:{...s(x,I)};if(Ce==="*"){const N=s(x,T)["*"];N&&(n.push(...b(this,j,K).call(this,N,t,s(x,I))),f(N,I,H),v.push(N));continue}const[bt,Me,fe]=Ce;if(!g&&!(fe instanceof RegExp))continue;const D=s(x,T)[bt],xt=i.slice(d).join("/");if(fe instanceof RegExp){const N=fe.exec(xt);if(N){if(H[Me]=N[0],n.push(...b(this,j,K).call(this,D,t,s(x,I),H)),Object.keys(s(D,T)).length){f(D,I,H);const He=((l=N[0].match(/\//))==null?void 0:l.length)??0;(c[He]||(c[He]=[])).push(D)}continue}}(fe===!0||fe.test(g))&&(H[Me]=g,p?(n.push(...b(this,j,K).call(this,D,t,H,s(x,I))),s(D,T)["*"]&&n.push(...b(this,j,K).call(this,s(D,T)["*"],t,H,s(x,I)))):(f(D,I,H),v.push(D)))}}o=v.concat(c.shift()??[])}return n.length>1&&n.sort((d,u)=>d.score-u.score),[n.map(({handler:d,params:u})=>[d,u])]}},W=new WeakMap,T=new WeakMap,Q=new WeakMap,ue=new WeakMap,I=new WeakMap,j=new WeakSet,K=function(t,a,n,r){const o=[];for(let i=0,c=s(t,W).length;i<c;i++){const l=s(t,W)[i],d=l[a]||l[y],u={};if(d!==void 0&&(d.params=Object.create(null),o.push(d),n!==he||r&&r!==he))for(let g=0,p=d.possibleKeys.length;g<p;g++){const v=d.possibleKeys[g],S=u[d.score];d.params[v]=r!=null&&r[v]&&!S?r[v]:n[v]??(r==null?void 0:r[v]),u[d.score]=!0}}return o},ge),ee,Qe,ea=(Qe=class{constructor(){h(this,"name","TrieRouter");m(this,ee);f(this,ee,new Qt)}add(e,t,a){const n=at(t);if(n){for(let r=0,o=n.length;r<o;r++)s(this,ee).insert(e,n[r],a);return}s(this,ee).insert(e,t,a)}match(e,t){return s(this,ee).search(e,t)}},ee=new WeakMap,Qe),mt=class extends $t{constructor(e={}){super(e),this.router=e.router??new Vt({routers:[new Jt,new ea]})}},ta=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(o=>typeof o=="string"?o==="*"?()=>o:i=>o===i?i:null:typeof o=="function"?o:i=>o.includes(i)?i:null)(a.origin),r=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(a.allowMethods);return async function(i,c){var u;function l(g,p){i.res.headers.set(g,p)}const d=await n(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const g=await r(i.req.header("origin")||"",i);g.length&&l("Access-Control-Allow-Methods",g.join(","));let p=a.allowHeaders;if(!(p!=null&&p.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(p=v.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await c(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};const k=new mt;k.use("/api/*",ta());const ze="cf2a50987a92a698e89d5efeb80cde82",Pe={face:"https://iili.io/fM9hV6B.png",outfit:"https://iili.io/fM99P3l.png",logo:"https://iili.io/fEiEfUB.png"};k.get("/api/bases",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=await fetch("https://api.airtable.com/v0/meta/bases",{headers:{Authorization:`Bearer ${t}`}});return e.json(await a.json())});k.get("/api/bases/:baseId/tables",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.param("baseId"),n=await fetch(`https://api.airtable.com/v0/meta/bases/${a}/tables`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await n.json())});k.get("/api/records",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),n=e.req.query("tableId"),r=e.req.query("filter")||"";if(!a||!n)return e.json({error:"Missing baseId or tableId"},400);let o=`https://api.airtable.com/v0/${a}/${n}?pageSize=50`;r&&r!=="all"&&(o+=`&filterByFormula={Status}='${r}'`);const i=await fetch(o,{headers:{Authorization:`Bearer ${t}`}});return e.json(await i.json())});k.get("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),n=e.req.query("tableId"),r=e.req.param("id");if(!a||!n)return e.json({error:"Missing baseId or tableId"},400);const o=await fetch(`https://api.airtable.com/v0/${a}/${n}/${r}`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await o.json())});k.patch("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),n=e.req.query("tableId"),r=e.req.param("id"),o=await e.req.json();if(!a||!n)return e.json({error:"Missing baseId or tableId"},400);const i=await fetch(`https://api.airtable.com/v0/${a}/${n}/${r}`,{method:"PATCH",headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({fields:o})});return e.json(await i.json())});k.post("/api/generate-image",async e=>{const{prompt:t,imageUrls:a,aspectRatio:n}=await e.req.json(),r={model:"google/nano-banana",input:{prompt:t,image_urls:a||[Pe.face,Pe.outfit,Pe.logo],image_size:n||"16:9",output_format:"png"}};console.log("KieAI Nano Banana Request:",JSON.stringify(r,null,2));const o=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${ze}`,"Content-Type":"application/json"},body:JSON.stringify(r)});return e.json(await o.json())});const Ze={"16:9":"https://iili.io/fk9ypqB.png","9:16":"https://iili.io/fk9yy0P.png","1:1":"https://iili.io/fkH99g1.png"};k.post("/api/generate-image-ideogram",async e=>{const{prompt:t,imageUrl:a,aspectRatio:n}=await e.req.json(),r=Ze[n]||Ze["16:9"],o={model:"ideogram/character-edit",input:{prompt:t,image_url:a,mask_url:r,rendering_speed:"BALANCED",style:"AUTO",expand_prompt:!1,num_images:"1"}};console.log("Ideogram character-edit Request (text overlay):",JSON.stringify(o,null,2));const i=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${ze}`,"Content-Type":"application/json"},body:JSON.stringify(o)});return e.json(await i.json())});k.get("/api/task-status/:taskId",async e=>{const t=e.req.param("taskId"),a=await fetch(`https://api.kie.ai/api/v1/jobs/recordInfo?taskId=${t}`,{headers:{Authorization:`Bearer ${ze}`}});return e.json(await a.json())});k.post("/api/upload-image",async e=>{const{base64Image:t}=await e.req.json(),a=new FormData;a.append("key","6d207e02198a847aa98d0a2a901485a5"),a.append("action","upload"),a.append("source",t),a.append("format","json");const n=await fetch("https://freeimage.host/api/1/upload",{method:"POST",body:a});return e.json(await n.json())});k.post("/api/proxy-image",async e=>{try{const{imageUrl:t}=await e.req.json();if(!t)return e.json({error:"Missing imageUrl"},400);const a=await fetch(t);if(!a.ok)return e.json({error:"Failed to fetch image: "+a.status},500);const n=await a.arrayBuffer(),r=new Uint8Array(n);let o="";for(let l=0;l<r.length;l++)o+=String.fromCharCode(r[l]);const i=btoa(o),c=a.headers.get("content-type")||"image/png";return e.json({success:!0,base64:i,contentType:c,dataUrl:"data:"+c+";base64,"+i})}catch(t){return e.json({error:"Proxy error: "+t.message},500)}});k.get("/",e=>e.html(`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body class="text-gray-100">
  ...
  `));const We=new mt,aa=Object.assign({"/src/index.tsx":k});let pt=!1;for(const[,e]of Object.entries(aa))e&&(We.route("/",e),We.notFound(e.notFoundHandler),pt=!0);if(!pt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{We as default};
