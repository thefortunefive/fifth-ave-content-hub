var It=Object.defineProperty;var Ge=e=>{throw TypeError(e)};var Tt=(e,t,a)=>t in e?It(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var h=(e,t,a)=>Tt(e,typeof t!="symbol"?t+"":t,a),De=(e,t,a)=>t.has(e)||Ge("Cannot "+a);var s=(e,t,a)=>(De(e,t,"read from private field"),a?a.call(e):t.get(e)),p=(e,t,a)=>t.has(e)?Ge("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),f=(e,t,a,r)=>(De(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),b=(e,t,a)=>(De(e,t,"access private method"),a);var _e=(e,t,a,r)=>({set _(n){f(e,t,n,a)},get _(){return s(e,t,r)}});var qe=(e,t,a)=>(r,n)=>{let o=-1;return i(0);async function i(d){if(d<=o)throw new Error("next() called multiple times");o=d;let l,c=!1,u;if(e[d]?(u=e[d][0][0],r.req.routeIndex=d):u=d===e.length&&n||void 0,u)try{l=await u(r,()=>i(d+1))}catch(g){if(g instanceof Error&&t)r.error=g,l=await t(g,r),c=!0;else throw g}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},St=Symbol(),Ct=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,o=(e instanceof st?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?Et(e,{all:a,dot:r}):{}};async function Et(e,t){const a=await e.formData();return a?kt(a,t):{}}function kt(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?Rt(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(Lt(a,r,n),delete a[r])}),a}var Rt=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Lt=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((o,i)=>{i===n.length-1?r[o]=a:((!r[o]||typeof r[o]!="object"||Array.isArray(r[o])||r[o]instanceof File)&&(r[o]=Object.create(null)),r=r[o])})},at=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},At=e=>{const{groups:t,path:a}=Bt(e),r=at(a);return Ht(r,t)},Bt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},Ht=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},Ce={},Dt=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return Ce[r]||(a[2]?Ce[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Ce[r]=[e,a[1],!0]),Ce[r]}return null},Fe=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Ot=e=>Fe(e,decodeURI),rt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const o=t.indexOf("?",r),i=t.slice(a,o===-1?void 0:o);return Ot(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(n===63)break}return t.slice(a,r)},Pt=e=>{const t=rt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},re=(e,t,...a)=>(a.length&&(t=re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),nt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const o=n.replace("?","");r+="/"+o,a.push(r)}else r+="/"+n}),a.filter((n,o,i)=>i.indexOf(n)===o)},Oe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Fe(e,it):e):e,ot=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const d=e.charCodeAt(i+t.length+1);if(d===61){const l=i+t.length+2,c=e.indexOf("&",l);return Oe(e.slice(l,c===-1?void 0:c))}else if(d==38||isNaN(d))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const i=e.indexOf("&",o+1);let d=e.indexOf("=",o);d>i&&i!==-1&&(d=-1);let l=e.slice(o+1,d===-1?i===-1?void 0:i:d);if(r&&(l=Oe(l)),o=i,l==="")continue;let c;d===-1?c="":(c=e.slice(d+1,i===-1?void 0:i),r&&(c=Oe(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},jt=ot,Ut=(e,t)=>ot(e,t,!0),it=decodeURIComponent,We=e=>Fe(e,it),ie,R,F,lt,ct,Ue,$,Xe,st=(Xe=class{constructor(e,t="/",a=[[]]){p(this,F);h(this,"raw");p(this,ie);p(this,R);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});p(this,$,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,f(this,R,a),f(this,ie,{})}param(e){return e?b(this,F,lt).call(this,e):b(this,F,ct).call(this)}query(e){return jt(this.url,e)}queries(e){return Ut(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ct(this,e))}json(){return s(this,$).call(this,"text").then(e=>JSON.parse(e))}text(){return s(this,$).call(this,"text")}arrayBuffer(){return s(this,$).call(this,"arrayBuffer")}blob(){return s(this,$).call(this,"blob")}formData(){return s(this,$).call(this,"formData")}addValidatedData(e,t){s(this,ie)[e]=t}valid(e){return s(this,ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[St](){return s(this,R)}get matchedRoutes(){return s(this,R)[0].map(([[,e]])=>e)}get routePath(){return s(this,R)[0].map(([[,e]])=>e)[this.routeIndex].path}},ie=new WeakMap,R=new WeakMap,F=new WeakSet,lt=function(e){const t=s(this,R)[0][this.routeIndex][1][e],a=b(this,F,Ue).call(this,t);return a&&/\%/.test(a)?We(a):a},ct=function(){const e={},t=Object.keys(s(this,R)[0][this.routeIndex][1]);for(const a of t){const r=b(this,F,Ue).call(this,s(this,R)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?We(r):r)}return e},Ue=function(e){return s(this,R)[1]?s(this,R)[1][e]:e},$=new WeakMap,Xe),Ft={Stringify:1},dt=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(n?n[0]+=e:n=[e],Promise.all(o.map(d=>d({phase:t,buffer:n,context:r}))).then(d=>Promise.all(d.filter(Boolean).map(l=>dt(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},zt="text/plain; charset=UTF-8",Pe=(e,t)=>({"Content-Type":e,...t}),be,xe,O,se,P,k,ve,le,ce,X,ye,we,G,ne,Ve,Nt=(Ve=class{constructor(e,t){p(this,G);p(this,be);p(this,xe);h(this,"env",{});p(this,O);h(this,"finalized",!1);h(this,"error");p(this,se);p(this,P);p(this,k);p(this,ve);p(this,le);p(this,ce);p(this,X);p(this,ye);p(this,we);h(this,"render",(...e)=>(s(this,le)??f(this,le,t=>this.html(t)),s(this,le).call(this,...e)));h(this,"setLayout",e=>f(this,ve,e));h(this,"getLayout",()=>s(this,ve));h(this,"setRenderer",e=>{f(this,le,e)});h(this,"header",(e,t,a)=>{this.finalized&&f(this,k,new Response(s(this,k).body,s(this,k)));const r=s(this,k)?s(this,k).headers:s(this,X)??f(this,X,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});h(this,"status",e=>{f(this,se,e)});h(this,"set",(e,t)=>{s(this,O)??f(this,O,new Map),s(this,O).set(e,t)});h(this,"get",e=>s(this,O)?s(this,O).get(e):void 0);h(this,"newResponse",(...e)=>b(this,G,ne).call(this,...e));h(this,"body",(e,t,a)=>b(this,G,ne).call(this,e,t,a));h(this,"text",(e,t,a)=>!s(this,X)&&!s(this,se)&&!t&&!a&&!this.finalized?new Response(e):b(this,G,ne).call(this,e,t,Pe(zt,a)));h(this,"json",(e,t,a)=>b(this,G,ne).call(this,JSON.stringify(e),t,Pe("application/json",a)));h(this,"html",(e,t,a)=>{const r=n=>b(this,G,ne).call(this,n,t,Pe("text/html; charset=UTF-8",a));return typeof e=="object"?dt(e,Ft.Stringify,!1,{}).then(r):r(e)});h(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});h(this,"notFound",()=>(s(this,ce)??f(this,ce,()=>new Response),s(this,ce).call(this,this)));f(this,be,e),t&&(f(this,P,t.executionCtx),this.env=t.env,f(this,ce,t.notFoundHandler),f(this,we,t.path),f(this,ye,t.matchResult))}get req(){return s(this,xe)??f(this,xe,new st(s(this,be),s(this,we),s(this,ye))),s(this,xe)}get event(){if(s(this,P)&&"respondWith"in s(this,P))return s(this,P);throw Error("This context has no FetchEvent")}get executionCtx(){if(s(this,P))return s(this,P);throw Error("This context has no ExecutionContext")}get res(){return s(this,k)||f(this,k,new Response(null,{headers:s(this,X)??f(this,X,new Headers)}))}set res(e){if(s(this,k)&&e){e=new Response(e.body,e);for(const[t,a]of s(this,k).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=s(this,k).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}f(this,k,e),this.finalized=!0}get var(){return s(this,O)?Object.fromEntries(s(this,O)):{}}},be=new WeakMap,xe=new WeakMap,O=new WeakMap,se=new WeakMap,P=new WeakMap,k=new WeakMap,ve=new WeakMap,le=new WeakMap,ce=new WeakMap,X=new WeakMap,ye=new WeakMap,we=new WeakMap,G=new WeakSet,ne=function(e,t,a){const r=s(this,k)?new Headers(s(this,k).headers):s(this,X)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,d]of o)i.toLowerCase()==="set-cookie"?r.append(i,d):r.set(i,d)}if(a)for(const[o,i]of Object.entries(a))if(typeof i=="string")r.set(o,i);else{r.delete(o);for(const d of i)r.append(o,d)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??s(this,se);return new Response(e,{status:n,headers:r})},Ve),y="ALL",Mt="all",$t=["get","post","put","delete","options","patch"],ut="Can not add a route since the matcher is already built.",gt=class extends Error{},Gt="__COMPOSED_HANDLER",_t=e=>e.text("404 Not Found",404),Ze=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},L,w,ft,A,Y,Ee,ke,de,qt=(de=class{constructor(t={}){p(this,w);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");p(this,L,"/");h(this,"routes",[]);p(this,A,_t);h(this,"errorHandler",Ze);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(f(this,A,t),this));h(this,"fetch",(t,...a)=>b(this,w,ke).call(this,t,a[1],a[0],t.method));h(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${re("/",t)}`,a),r,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,w,ke).call(this,t.request,t,void 0,t.request.method))})});[...$t,Mt].forEach(o=>{this[o]=(i,...d)=>(typeof i=="string"?f(this,L,i):b(this,w,Y).call(this,o,s(this,L),i),d.forEach(l=>{b(this,w,Y).call(this,o,s(this,L),l)}),this)}),this.on=(o,i,...d)=>{for(const l of[i].flat()){f(this,L,l);for(const c of[o].flat())d.map(u=>{b(this,w,Y).call(this,c.toUpperCase(),s(this,L),u)})}return this},this.use=(o,...i)=>(typeof o=="string"?f(this,L,o):(f(this,L,"*"),i.unshift(o)),i.forEach(d=>{b(this,w,Y).call(this,y,s(this,L),d)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??rt:Pt}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let o;a.errorHandler===Ze?o=n.handler:(o=async(d,l)=>(await qe([],a.errorHandler)(d,()=>n.handler(d,l))).res,o[Gt]=n.handler),b(i=r,w,Y).call(i,n.method,n.path,o)}),this}basePath(t){const a=b(this,w,ft).call(this);return a._basePath=re(this._basePath,t),a}mount(t,a,r){let n,o;r&&(typeof r=="function"?o=r:(o=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=o?l=>{const c=o(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=re(this._basePath,t),c=l==="/"?0:l.length;return u=>{const g=new URL(u.url);return g.pathname=g.pathname.slice(c)||"/",new Request(g,u)}})());const d=async(l,c)=>{const u=await a(n(l.req.raw),...i(l));if(u)return u;await c()};return b(this,w,Y).call(this,y,re(t,"*"),d),this}},L=new WeakMap,w=new WeakSet,ft=function(){const t=new de({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,A,s(this,A)),t.routes=this.routes,t},A=new WeakMap,Y=function(t,a,r){t=t.toUpperCase(),a=re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},Ee=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ke=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,w,ke).call(this,t,a,r,"GET")))();const o=this.getPath(t,{env:r}),i=this.router.match(n,o),d=new Nt(t,{path:o,matchResult:i,env:r,executionCtx:a,notFoundHandler:s(this,A)});if(i[0].length===1){let c;try{c=i[0][0][0][0](d,async()=>{d.res=await s(this,A).call(this,d)})}catch(u){return b(this,w,Ee).call(this,u,d)}return c instanceof Promise?c.then(u=>u||(d.finalized?d.res:s(this,A).call(this,d))).catch(u=>b(this,w,Ee).call(this,u,d)):c??s(this,A).call(this,d)}const l=qe(i[0],this.errorHandler,s(this,A));return(async()=>{try{const c=await l(d);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return b(this,w,Ee).call(this,c,d)}})()},de),ht=[];function Wt(e,t){const a=this.buildAllMatchers(),r=(n,o)=>{const i=a[n]||a[y],d=i[2][o];if(d)return d;const l=o.match(i[0]);if(!l)return[[],ht];const c=l.indexOf("",1);return[i[1][c],l]};return this.match=r,r(e,t)}var Le="[^/]+",pe=".*",me="(?:|/.*)",oe=Symbol(),Zt=new Set(".\\+*[^]$()");function Yt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===pe||e===me?1:t===pe||t===me?-1:e===Le?1:t===Le?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var V,J,B,te,Kt=(te=class{constructor(){p(this,V);p(this,J);p(this,B,Object.create(null))}insert(t,a,r,n,o){if(t.length===0){if(s(this,V)!==void 0)throw oe;if(o)return;f(this,V,a);return}const[i,...d]=t,l=i==="*"?d.length===0?["","",pe]:["","",Le]:i==="/*"?["","",me]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let g=l[2]||Le;if(u&&l[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw oe;if(c=s(this,B)[g],!c){if(Object.keys(s(this,B)).some(m=>m!==pe&&m!==me))throw oe;if(o)return;c=s(this,B)[g]=new te,u!==""&&f(c,J,n.varIndex++)}!o&&u!==""&&r.push([u,s(c,J)])}else if(c=s(this,B)[i],!c){if(Object.keys(s(this,B)).some(u=>u.length>1&&u!==pe&&u!==me))throw oe;if(o)return;c=s(this,B)[i]=new te}c.insert(d,a,r,n,o)}buildRegExpStr(){const a=Object.keys(s(this,B)).sort(Yt).map(r=>{const n=s(this,B)[r];return(typeof s(n,J)=="number"?`(${r})@${s(n,J)}`:Zt.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof s(this,V)=="number"&&a.unshift(`#${s(this,V)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},V=new WeakMap,J=new WeakMap,B=new WeakMap,te),Ae,Ie,Je,Xt=(Je=class{constructor(){p(this,Ae,{varIndex:0});p(this,Ie,new Kt)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let d=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return n[i]=[c,l],i++,d=!0,c}),!d)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[d]=n[i];for(let l=o.length-1;l>=0;l--)if(o[l].indexOf(d)!==-1){o[l]=o[l].replace(d,n[i][1]);break}}return s(this,Ie).insert(o,t,r,s(this,Ae),a),r}buildRegExp(){let e=s(this,Ie).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,i)=>o!==void 0?(a[++t]=Number(o),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},Ae=new WeakMap,Ie=new WeakMap,Je),Vt=[/^$/,[],Object.create(null)],Re=Object.create(null);function pt(e){return Re[e]??(Re[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Jt(){Re=Object.create(null)}function Qt(e){var c;const t=new Xt,a=[];if(e.length===0)return Vt;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,g],[m,x])=>u?1:m?-1:g.length-x.length),n=Object.create(null);for(let u=0,g=-1,m=r.length;u<m;u++){const[x,I,z]=r[u];x?n[I]=[z.map(([E])=>[E,Object.create(null)]),ht]:g++;let v;try{v=t.insert(I,g,x)}catch(E){throw E===oe?new gt(I):E}x||(a[g]=z.map(([E,N])=>{const Te=Object.create(null);for(N-=1;N>=0;N--){const[Se,H]=v[N];Te[Se]=H}return[E,Te]}))}const[o,i,d]=t.buildRegExp();for(let u=0,g=a.length;u<g;u++)for(let m=0,x=a[u].length;m<x;m++){const I=(c=a[u][m])==null?void 0:c[1];if(!I)continue;const z=Object.keys(I);for(let v=0,E=z.length;v<E;v++)I[z[v]]=d[I[z[v]]]}const l=[];for(const u in i)l[u]=a[i[u]];return[o,l,n]}function ae(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(pt(a).test(t))return[...e[a]]}}var _,q,Be,mt,Qe,ea=(Qe=class{constructor(){p(this,Be);h(this,"name","RegExpRouter");p(this,_);p(this,q);h(this,"match",Wt);f(this,_,{[y]:Object.create(null)}),f(this,q,{[y]:Object.create(null)})}add(e,t,a){var d;const r=s(this,_),n=s(this,q);if(!r||!n)throw new Error(ut);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[y]).forEach(c=>{l[e][c]=[...l[y][c]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=pt(t);e===y?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=ae(r[c],t)||ae(r[y],t)||[])}):(d=r[e])[t]||(d[t]=ae(r[e],t)||ae(r[y],t)||[]),Object.keys(r).forEach(c=>{(e===y||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([a,o])})}),Object.keys(n).forEach(c=>{(e===y||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([a,o]))});return}const i=nt(t)||[t];for(let l=0,c=i.length;l<c;l++){const u=i[l];Object.keys(n).forEach(g=>{var m;(e===y||e===g)&&((m=n[g])[u]||(m[u]=[...ae(r[g],u)||ae(r[y],u)||[]]),n[g][u].push([a,o-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(s(this,q)).concat(Object.keys(s(this,_))).forEach(t=>{e[t]||(e[t]=b(this,Be,mt).call(this,t))}),f(this,_,f(this,q,void 0)),Jt(),e}},_=new WeakMap,q=new WeakMap,Be=new WeakSet,mt=function(e){const t=[];let a=e===y;return[s(this,_),s(this,q)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(o=>[o,r[e][o]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==y&&t.push(...Object.keys(r[y]).map(o=>[o,r[y][o]]))}),a?Qt(t):null},Qe),W,j,et,ta=(et=class{constructor(e){h(this,"name","SmartRouter");p(this,W,[]);p(this,j,[]);f(this,W,e.routers)}add(e,t,a){if(!s(this,j))throw new Error(ut);s(this,j).push([e,t,a])}match(e,t){if(!s(this,j))throw new Error("Fatal error");const a=s(this,W),r=s(this,j),n=a.length;let o=0,i;for(;o<n;o++){const d=a[o];try{for(let l=0,c=r.length;l<c;l++)d.add(...r[l]);i=d.match(e,t)}catch(l){if(l instanceof gt)continue;throw l}this.match=d.match.bind(d),f(this,W,[d]),f(this,j,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(s(this,j)||s(this,W).length!==1)throw new Error("No active router has been determined yet.");return s(this,W)[0]}},W=new WeakMap,j=new WeakMap,et),he=Object.create(null),Z,C,Q,ue,T,U,K,ge,aa=(ge=class{constructor(t,a,r){p(this,U);p(this,Z);p(this,C);p(this,Q);p(this,ue,0);p(this,T,he);if(f(this,C,r||Object.create(null)),f(this,Z,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},f(this,Z,[n])}f(this,Q,[])}insert(t,a,r){f(this,ue,++_e(this,ue)._);let n=this;const o=At(a),i=[];for(let d=0,l=o.length;d<l;d++){const c=o[d],u=o[d+1],g=Dt(c,u),m=Array.isArray(g)?g[0]:c;if(m in s(n,C)){n=s(n,C)[m],g&&i.push(g[1]);continue}s(n,C)[m]=new ge,g&&(s(n,Q).push(g),i.push(g[1])),n=s(n,C)[m]}return s(n,Z).push({[t]:{handler:r,possibleKeys:i.filter((d,l,c)=>c.indexOf(d)===l),score:s(this,ue)}}),n}search(t,a){var l;const r=[];f(this,T,he);let o=[this];const i=at(a),d=[];for(let c=0,u=i.length;c<u;c++){const g=i[c],m=c===u-1,x=[];for(let I=0,z=o.length;I<z;I++){const v=o[I],E=s(v,C)[g];E&&(f(E,T,s(v,T)),m?(s(E,C)["*"]&&r.push(...b(this,U,K).call(this,s(E,C)["*"],t,s(v,T))),r.push(...b(this,U,K).call(this,E,t,s(v,T)))):x.push(E));for(let N=0,Te=s(v,Q).length;N<Te;N++){const Se=s(v,Q)[N],H=s(v,T)===he?{}:{...s(v,T)};if(Se==="*"){const M=s(v,C)["*"];M&&(r.push(...b(this,U,K).call(this,M,t,s(v,T))),f(M,T,H),x.push(M));continue}const[yt,$e,fe]=Se;if(!g&&!(fe instanceof RegExp))continue;const D=s(v,C)[yt],wt=i.slice(c).join("/");if(fe instanceof RegExp){const M=fe.exec(wt);if(M){if(H[$e]=M[0],r.push(...b(this,U,K).call(this,D,t,s(v,T),H)),Object.keys(s(D,C)).length){f(D,T,H);const He=((l=M[0].match(/\//))==null?void 0:l.length)??0;(d[He]||(d[He]=[])).push(D)}continue}}(fe===!0||fe.test(g))&&(H[$e]=g,m?(r.push(...b(this,U,K).call(this,D,t,H,s(v,T))),s(D,C)["*"]&&r.push(...b(this,U,K).call(this,s(D,C)["*"],t,H,s(v,T)))):(f(D,T,H),x.push(D)))}}o=x.concat(d.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},Z=new WeakMap,C=new WeakMap,Q=new WeakMap,ue=new WeakMap,T=new WeakMap,U=new WeakSet,K=function(t,a,r,n){const o=[];for(let i=0,d=s(t,Z).length;i<d;i++){const l=s(t,Z)[i],c=l[a]||l[y],u={};if(c!==void 0&&(c.params=Object.create(null),o.push(c),r!==he||n&&n!==he))for(let g=0,m=c.possibleKeys.length;g<m;g++){const x=c.possibleKeys[g],I=u[c.score];c.params[x]=n!=null&&n[x]&&!I?n[x]:r[x]??(n==null?void 0:n[x]),u[c.score]=!0}}return o},ge),ee,tt,ra=(tt=class{constructor(){h(this,"name","TrieRouter");p(this,ee);f(this,ee,new aa)}add(e,t,a){const r=nt(t);if(r){for(let n=0,o=r.length;n<o;n++)s(this,ee).insert(e,r[n],a);return}s(this,ee).insert(e,t,a)}match(e,t){return s(this,ee).search(e,t)}},ee=new WeakMap,tt),bt=class extends qt{constructor(e={}){super(e),this.router=e.router??new ta({routers:[new ea,new ra]})}},na=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(o=>typeof o=="string"?o==="*"?()=>o:i=>o===i?i:null:typeof o=="function"?o:i=>o.includes(i)?i:null)(a.origin),n=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(a.allowMethods);return async function(i,d){var u;function l(g,m){i.res.headers.set(g,m)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const g=await n(i.req.header("origin")||"",i);g.length&&l("Access-Control-Allow-Methods",g.join(","));let m=a.allowHeaders;if(!(m!=null&&m.length)){const x=i.req.header("Access-Control-Request-Headers");x&&(m=x.split(/\s*,\s*/))}return m!=null&&m.length&&(l("Access-Control-Allow-Headers",m.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await d(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};const S=new bt;S.use("/api/*",na());const ze="cf2a50987a92a698e89d5efeb80cde82",je={face:"https://iili.io/fM9hV6B.png",outfit:"https://iili.io/fM99P3l.png",logo:"https://iili.io/fEiEfUB.png"};S.get("/api/bases",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=await fetch("https://api.airtable.com/v0/meta/bases",{headers:{Authorization:`Bearer ${t}`}});return e.json(await a.json())});S.get("/api/bases/:baseId/tables",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.param("baseId"),r=await fetch(`https://api.airtable.com/v0/meta/bases/${a}/tables`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await r.json())});S.get("/api/records",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.query("filter")||"";if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);let o=`https://api.airtable.com/v0/${a}/${r}?pageSize=50`;n&&n!=="all"&&(o+=`&filterByFormula={Status}='${n}'`);const i=await fetch(o,{headers:{Authorization:`Bearer ${t}`}});return e.json(await i.json())});S.get("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id");if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const o=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{headers:{Authorization:`Bearer ${t}`}});return e.json(await o.json())});S.patch("/api/records/:id",async e=>{const t=e.req.header("X-Airtable-Token");if(!t)return e.json({error:"Missing Airtable token"},401);const a=e.req.query("baseId"),r=e.req.query("tableId"),n=e.req.param("id"),o=await e.req.json();if(!a||!r)return e.json({error:"Missing baseId or tableId"},400);const i=await fetch(`https://api.airtable.com/v0/${a}/${r}/${n}`,{method:"PATCH",headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({fields:o})});return e.json(await i.json())});S.post("/api/generate-image",async e=>{const{prompt:t,imageUrls:a,aspectRatio:r}=await e.req.json(),n={model:"google/nano-banana",input:{prompt:t,image_urls:a||[je.face,je.outfit,je.logo],image_size:r||"16:9",output_format:"png"}};console.log("KieAI Nano Banana Request:",JSON.stringify(n,null,2));const o=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${ze}`,"Content-Type":"application/json"},body:JSON.stringify(n)});return e.json(await o.json())});const Ye={"16:9":"https://iili.io/fk9ypqB.png","9:16":"https://iili.io/fk9yy0P.png","1:1":"https://iili.io/fkH99g1.png"};S.post("/api/generate-image-ideogram",async e=>{const{prompt:t,imageUrl:a,aspectRatio:r}=await e.req.json(),n=Ye[r]||Ye["16:9"],o={model:"ideogram/character-edit",input:{prompt:t,image_url:a,mask_url:n,rendering_speed:"BALANCED",style:"AUTO",expand_prompt:!1,num_images:"1"}};console.log("Ideogram character-edit Request (text overlay):",JSON.stringify(o,null,2));const i=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${ze}`,"Content-Type":"application/json"},body:JSON.stringify(o)});return e.json(await i.json())});S.get("/api/task-status/:taskId",async e=>{const t=e.req.param("taskId"),a=await fetch(`https://api.kie.ai/api/v1/jobs/recordInfo?taskId=${t}`,{headers:{Authorization:`Bearer ${ze}`}});return e.json(await a.json())});S.post("/api/upload-image",async e=>{const{base64Image:t}=await e.req.json(),a=new FormData;a.append("key","6d207e02198a847aa98d0a2a901485a5"),a.append("action","upload"),a.append("source",t),a.append("format","json");const r=await fetch("https://freeimage.host/api/1/upload",{method:"POST",body:a});return e.json(await r.json())});S.post("/api/proxy-image",async e=>{try{const{imageUrl:t}=await e.req.json();if(!t)return e.json({error:"Missing imageUrl"},400);const a=await fetch(t);if(!a.ok)return e.json({error:"Failed to fetch image: "+a.status},500);const r=await a.arrayBuffer(),n=new Uint8Array(r);let o="";for(let l=0;l<n.length;l++)o+=String.fromCharCode(n[l]);const i=btoa(o),d=a.headers.get("content-type")||"image/png";return e.json({success:!0,base64:i,contentType:d,dataUrl:"data:"+d+";base64,"+i})}catch(t){return e.json({error:"Proxy error: "+t.message},500)}});const Ne={crypto:{baseId:"appgyL5gKf8rjaJPv",tableId:"tblZwA0JCNPeORaGi",fieldMap:{url:"sourceURL",title:"sourceHeadline",notes:"sourceSummary",platforms:"socialChannels",status:"Status",statusValue:"Needs Approval"}},ai:{baseId:"appgyL5gKf8rjaJPv",tableId:"tblSXrbwYXTQC7D2u",fieldMap:{url:"sourceURL",title:"sourceHeadline",notes:"sourceSummary",platforms:"socialChannels",status:"Status",statusValue:"Needs Approval"}},general:{baseId:"appQggEi0kxkoSmLn",tableId:"tblhAFDUnMcdO8DLk",fieldMap:{url:"Video URL",title:"Video Title",notes:"Notes",platforms:"Platforms",status:"Status",statusValue:"Pending Review"}}},oa=["Twitter","LinkedIn","Blog","Instagram","Facebook","Avatar"],Me="patzmYCtUSKROFbsw.ebdd70b78b2f422fd5a6da1aa867be11f690a795117c9e13d9d4747708018921",ia={crypto:"https://fifthaveai.app.n8n.cloud/webhook/crypto-pickup",ai:"https://fifthaveai.app.n8n.cloud/webhook/ai-pickup"};async function xt(e,t,a){const r=ia[e];if(r)try{await new Promise(o=>setTimeout(o,2e3)),console.log(`[Instant Pickup] Triggering ${e} webhook for record ${t}`);const n=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({recordId:t,sourceURL:a.sourceURL,sourceHeadline:a.sourceHeadline,sourceSummary:a.sourceSummary,topic:e,triggeredAt:new Date().toISOString()})});console.log(`[Instant Pickup] Webhook response: ${n.status}`)}catch(n){console.error("[Instant Pickup] Webhook error:",n.message)}}S.post("/api/save",async e=>{try{const{url:t,title:a,notes:r,platforms:n,topic:o}=await e.req.json();if(!t)return e.json({success:!1,error:"URL is required"},400);const i=o||"general",d=Ne[i];if(!d)return e.json({success:!1,error:"Invalid topic. Use: crypto, ai, or general"},400);const l=d.fieldMap,c={};if(c[l.url]=t,c[l.title]=a||"",c[l.status]=l.statusValue,r&&(c[l.notes]=r),n&&n.length>0)if(i==="crypto"||i==="ai"){const x=n.filter(I=>oa.includes(I));x.length>0&&(c[l.platforms]=x)}else c[l.platforms]=n;i==="general"&&(c["Created Date"]=new Date().toISOString());const g=await(await fetch(`https://api.airtable.com/v0/${d.baseId}/${d.tableId}`,{method:"POST",headers:{Authorization:`Bearer ${Me}`,"Content-Type":"application/json"},body:JSON.stringify({fields:c})})).json();if(g.error)return console.error("Airtable error:",g.error),e.json({success:!1,error:g.error.message||"Airtable error"},500);let m=!1;if((i==="crypto"||i==="ai")&&g.id){m=!0;const x=xt(i,g.id,{sourceURL:t,sourceHeadline:a||"",sourceSummary:r||""});e.executionCtx&&typeof e.executionCtx.waitUntil=="function"?e.executionCtx.waitUntil(x):x.catch(I=>console.error("[Instant Pickup] Background error:",I))}return e.json({success:!0,record:g,topic:i,table:i==="general"?"Content Pipeline":i==="crypto"?"Social Posts":"Social Posts - AI",processing:m?"started":"not_applicable"})}catch(t){return console.error("Save error:",t),e.json({success:!1,error:t.message||"Server error"},500)}});S.get("/api/process-status/:recordId",async e=>{try{const t=e.req.param("recordId"),a=e.req.query("topic")||"crypto",r=Ne[a];if(!r)return e.json({error:"Invalid topic"},400);const i=(await(await fetch(`https://api.airtable.com/v0/${r.baseId}/${r.tableId}/${t}`,{headers:{Authorization:`Bearer ${Me}`}})).json()).fields||{},d=!!(i.sourceSummary&&i.sourceSummary.length>50),l=!!(i.imagePrompt&&i.imagePrompt.length>10),c=!!(i.twitterCopy&&i.twitterCopy.length>5);let u="processing";return d&&l&&c?u="complete":d&&(u="generating_content"),e.json({recordId:t,status:u,fields:{hasResearch:d,hasImagePrompt:l,hasSocialContent:c,rewrittenHeadline:i.rewrittenHeadline||null}})}catch(t){return e.json({error:t.message},500)}});S.post("/api/process",async e=>{try{const{recordId:t,topic:a}=await e.req.json();if(!t||!a)return e.json({error:"recordId and topic are required"},400);if(a==="general")return e.json({error:"Processing only available for crypto/ai topics"},400);const r=Ne[a];if(!r)return e.json({error:"Invalid topic"},400);const i=(await(await fetch(`https://api.airtable.com/v0/${r.baseId}/${r.tableId}/${t}`,{headers:{Authorization:`Bearer ${Me}`}})).json()).fields||{};return await xt(a,t,{sourceURL:i.sourceURL||"",sourceHeadline:i.sourceHeadline||"",sourceSummary:i.sourceSummary||""}),e.json({success:!0,status:"processing_started",recordId:t})}catch(t){return e.json({error:t.message},500)}});S.get("/api/topics",e=>e.json({topics:[{id:"crypto",label:"🪙 Crypto News",description:"Save to 5th Ave Crypto pipeline"},{id:"ai",label:"🤖 AI News",description:"Save to 5th Ave AI pipeline"},{id:"general",label:"📋 General Pipeline",description:"Save to Content Pipeline"}]}));S.get("/",e=>e.html(`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body class="text-gray-100">
  ...
  `));const Ke=new bt,sa=Object.assign({"/src/index.tsx":S});let vt=!1;for(const[,e]of Object.entries(sa))e&&(Ke.route("/",e),Ke.notFound(e.notFoundHandler),vt=!0);if(!vt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Ke as default};
