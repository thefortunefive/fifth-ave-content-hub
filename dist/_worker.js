var Dt=Object.defineProperty;var Ke=e=>{throw TypeError(e)};var At=(e,t,a)=>t in e?Dt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var m=(e,t,a)=>At(e,typeof t!="symbol"?t+"":t,a),Ne=(e,t,a)=>t.has(e)||Ke("Cannot "+a);var l=(e,t,a)=>(Ne(e,t,"read from private field"),a?a.call(e):t.get(e)),p=(e,t,a)=>t.has(e)?Ke("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),h=(e,t,a,r)=>(Ne(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),v=(e,t,a)=>(Ne(e,t,"access private method"),a);var Ve=(e,t,a,r)=>({set _(o){h(e,t,o,a)},get _(){return l(e,t,r)}});var Ye=(e,t,a)=>(r,o)=>{let n=-1;return s(0);async function s(d){if(d<=n)throw new Error("next() called multiple times");n=d;let i,c=!1,u;if(e[d]?(u=e[d][0][0],r.req.routeIndex=d):u=d===e.length&&o||void 0,u)try{i=await u(r,()=>s(d+1))}catch(g){if(g instanceof Error&&t)r.error=g,i=await t(g,r),c=!0;else throw g}else r.finalized===!1&&a&&(i=await a(r));return i&&(r.finalized===!1||c)&&(r.res=i),r}},Ht=Symbol(),Pt=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,n=(e instanceof ht?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Ot(e,{all:a,dot:r}):{}};async function Ot(e,t){const a=await e.formData();return a?Ut(a,t):{}}function Ut(e,t){const a=Object.create(null);return e.forEach((r,o)=>{t.all||o.endsWith("[]")?Nt(a,o,r):a[o]=r}),t.dot&&Object.entries(a).forEach(([r,o])=>{r.includes(".")&&(jt(a,r,o),delete a[r])}),a}var Nt=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},jt=(e,t,a)=>{let r=e;const o=t.split(".");o.forEach((n,s)=>{s===o.length-1?r[n]=a:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},lt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Mt=e=>{const{groups:t,path:a}=Ft(e),r=lt(a);return zt(r,t)},Ft=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const o=`@${r}`;return t.push([o,a]),o}),{groups:t,path:e}},zt=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let o=e.length-1;o>=0;o--)if(e[o].includes(r)){e[o]=e[o].replace(r,t[a][1]);break}}return e},ke={},$t=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return ke[r]||(a[2]?ke[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:ke[r]=[e,a[1],!0]),ke[r]}return null},Ge=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Gt=e=>Ge(e,decodeURI),ct=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const o=t.charCodeAt(r);if(o===37){const n=t.indexOf("?",r),s=t.slice(a,n===-1?void 0:n);return Gt(s.includes("%25")?s.replace(/%25/g,"%2525"):s)}else if(o===63)break}return t.slice(a,r)},_t=e=>{const t=ct(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},oe=(e,t,...a)=>(a.length&&(t=oe(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),dt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(o=>{if(o!==""&&!/\:/.test(o))r+="/"+o;else if(/\:/.test(o))if(/\?/.test(o)){a.length===0&&r===""?a.push("/"):a.push(r);const n=o.replace("?","");r+="/"+n,a.push(r)}else r+="/"+o}),a.filter((o,n,s)=>s.indexOf(o)===n)},je=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ge(e,gt):e):e,ut=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let s=e.indexOf("?",8);if(s===-1)return;for(e.startsWith(t,s+1)||(s=e.indexOf(`&${t}`,s+1));s!==-1;){const d=e.charCodeAt(s+t.length+1);if(d===61){const i=s+t.length+2,c=e.indexOf("&",i);return je(e.slice(i,c===-1?void 0:c))}else if(d==38||isNaN(d))return"";s=e.indexOf(`&${t}`,s+1)}if(r=/[%+]/.test(e),!r)return}const o={};r??(r=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const s=e.indexOf("&",n+1);let d=e.indexOf("=",n);d>s&&s!==-1&&(d=-1);let i=e.slice(n+1,d===-1?s===-1?void 0:s:d);if(r&&(i=je(i)),n=s,i==="")continue;let c;d===-1?c="":(c=e.slice(d+1,s===-1?void 0:s),r&&(c=je(c))),a?(o[i]&&Array.isArray(o[i])||(o[i]=[]),o[i].push(c)):o[i]??(o[i]=c)}return t?o[t]:o},Wt=ut,qt=(e,t)=>ut(e,t,!0),gt=decodeURIComponent,Je=e=>Ge(e,gt),ie,R,M,mt,ft,$e,G,at,ht=(at=class{constructor(e,t="/",a=[[]]){p(this,M);m(this,"raw");p(this,ie);p(this,R);m(this,"routeIndex",0);m(this,"path");m(this,"bodyCache",{});p(this,G,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const o=Object.keys(t)[0];return o?t[o].then(n=>(o==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,h(this,R,a),h(this,ie,{})}param(e){return e?v(this,M,mt).call(this,e):v(this,M,ft).call(this)}query(e){return Wt(this.url,e)}queries(e){return qt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Pt(this,e))}json(){return l(this,G).call(this,"text").then(e=>JSON.parse(e))}text(){return l(this,G).call(this,"text")}arrayBuffer(){return l(this,G).call(this,"arrayBuffer")}blob(){return l(this,G).call(this,"blob")}formData(){return l(this,G).call(this,"formData")}addValidatedData(e,t){l(this,ie)[e]=t}valid(e){return l(this,ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Ht](){return l(this,R)}get matchedRoutes(){return l(this,R)[0].map(([[,e]])=>e)}get routePath(){return l(this,R)[0].map(([[,e]])=>e)[this.routeIndex].path}},ie=new WeakMap,R=new WeakMap,M=new WeakSet,mt=function(e){const t=l(this,R)[0][this.routeIndex][1][e],a=v(this,M,$e).call(this,t);return a&&/\%/.test(a)?Je(a):a},ft=function(){const e={},t=Object.keys(l(this,R)[0][this.routeIndex][1]);for(const a of t){const r=v(this,M,$e).call(this,l(this,R)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Je(r):r)}return e},$e=function(e){return l(this,R)[1]?l(this,R)[1][e]:e},G=new WeakMap,at),Zt={Stringify:1},pt=async(e,t,a,r,o)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(o?o[0]+=e:o=[e],Promise.all(n.map(d=>d({phase:t,buffer:o,context:r}))).then(d=>Promise.all(d.filter(Boolean).map(i=>pt(i,t,!1,r,o))).then(()=>o[0]))):Promise.resolve(e)},Kt="text/plain; charset=UTF-8",Me=(e,t)=>({"Content-Type":e,...t}),xe,ve,O,le,U,S,ye,ce,de,J,we,Ie,_,ne,rt,Vt=(rt=class{constructor(e,t){p(this,_);p(this,xe);p(this,ve);m(this,"env",{});p(this,O);m(this,"finalized",!1);m(this,"error");p(this,le);p(this,U);p(this,S);p(this,ye);p(this,ce);p(this,de);p(this,J);p(this,we);p(this,Ie);m(this,"render",(...e)=>(l(this,ce)??h(this,ce,t=>this.html(t)),l(this,ce).call(this,...e)));m(this,"setLayout",e=>h(this,ye,e));m(this,"getLayout",()=>l(this,ye));m(this,"setRenderer",e=>{h(this,ce,e)});m(this,"header",(e,t,a)=>{this.finalized&&h(this,S,new Response(l(this,S).body,l(this,S)));const r=l(this,S)?l(this,S).headers:l(this,J)??h(this,J,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});m(this,"status",e=>{h(this,le,e)});m(this,"set",(e,t)=>{l(this,O)??h(this,O,new Map),l(this,O).set(e,t)});m(this,"get",e=>l(this,O)?l(this,O).get(e):void 0);m(this,"newResponse",(...e)=>v(this,_,ne).call(this,...e));m(this,"body",(e,t,a)=>v(this,_,ne).call(this,e,t,a));m(this,"text",(e,t,a)=>!l(this,J)&&!l(this,le)&&!t&&!a&&!this.finalized?new Response(e):v(this,_,ne).call(this,e,t,Me(Kt,a)));m(this,"json",(e,t,a)=>v(this,_,ne).call(this,JSON.stringify(e),t,Me("application/json",a)));m(this,"html",(e,t,a)=>{const r=o=>v(this,_,ne).call(this,o,t,Me("text/html; charset=UTF-8",a));return typeof e=="object"?pt(e,Zt.Stringify,!1,{}).then(r):r(e)});m(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});m(this,"notFound",()=>(l(this,de)??h(this,de,()=>new Response),l(this,de).call(this,this)));h(this,xe,e),t&&(h(this,U,t.executionCtx),this.env=t.env,h(this,de,t.notFoundHandler),h(this,Ie,t.path),h(this,we,t.matchResult))}get req(){return l(this,ve)??h(this,ve,new ht(l(this,xe),l(this,Ie),l(this,we))),l(this,ve)}get event(){if(l(this,U)&&"respondWith"in l(this,U))return l(this,U);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,U))return l(this,U);throw Error("This context has no ExecutionContext")}get res(){return l(this,S)||h(this,S,new Response(null,{headers:l(this,J)??h(this,J,new Headers)}))}set res(e){if(l(this,S)&&e){e=new Response(e.body,e);for(const[t,a]of l(this,S).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=l(this,S).headers.getSetCookie();e.headers.delete("set-cookie");for(const o of r)e.headers.append("set-cookie",o)}else e.headers.set(t,a)}h(this,S,e),this.finalized=!0}get var(){return l(this,O)?Object.fromEntries(l(this,O)):{}}},xe=new WeakMap,ve=new WeakMap,O=new WeakMap,le=new WeakMap,U=new WeakMap,S=new WeakMap,ye=new WeakMap,ce=new WeakMap,de=new WeakMap,J=new WeakMap,we=new WeakMap,Ie=new WeakMap,_=new WeakSet,ne=function(e,t,a){const r=l(this,S)?new Headers(l(this,S).headers):l(this,J)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[s,d]of n)s.toLowerCase()==="set-cookie"?r.append(s,d):r.set(s,d)}if(a)for(const[n,s]of Object.entries(a))if(typeof s=="string")r.set(n,s);else{r.delete(n);for(const d of s)r.append(n,d)}const o=typeof t=="number"?t:(t==null?void 0:t.status)??l(this,le);return new Response(e,{status:o,headers:r})},rt),I="ALL",Yt="all",Jt=["get","post","put","delete","options","patch"],bt="Can not add a route since the matcher is already built.",xt=class extends Error{},Xt="__COMPOSED_HANDLER",Qt=e=>e.text("404 Not Found",404),Xe=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},B,T,vt,D,V,Se,Re,ue,ea=(ue=class{constructor(t={}){p(this,T);m(this,"get");m(this,"post");m(this,"put");m(this,"delete");m(this,"options");m(this,"patch");m(this,"all");m(this,"on");m(this,"use");m(this,"router");m(this,"getPath");m(this,"_basePath","/");p(this,B,"/");m(this,"routes",[]);p(this,D,Qt);m(this,"errorHandler",Xe);m(this,"onError",t=>(this.errorHandler=t,this));m(this,"notFound",t=>(h(this,D,t),this));m(this,"fetch",(t,...a)=>v(this,T,Re).call(this,t,a[1],a[0],t.method));m(this,"request",(t,a,r,o)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,o):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${oe("/",t)}`,a),r,o)));m(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(v(this,T,Re).call(this,t.request,t,void 0,t.request.method))})});[...Jt,Yt].forEach(n=>{this[n]=(s,...d)=>(typeof s=="string"?h(this,B,s):v(this,T,V).call(this,n,l(this,B),s),d.forEach(i=>{v(this,T,V).call(this,n,l(this,B),i)}),this)}),this.on=(n,s,...d)=>{for(const i of[s].flat()){h(this,B,i);for(const c of[n].flat())d.map(u=>{v(this,T,V).call(this,c.toUpperCase(),l(this,B),u)})}return this},this.use=(n,...s)=>(typeof n=="string"?h(this,B,n):(h(this,B,"*"),s.unshift(n)),s.forEach(d=>{v(this,T,V).call(this,I,l(this,B),d)}),this);const{strict:r,...o}=t;Object.assign(this,o),this.getPath=r??!0?t.getPath??ct:_t}route(t,a){const r=this.basePath(t);return a.routes.map(o=>{var s;let n;a.errorHandler===Xe?n=o.handler:(n=async(d,i)=>(await Ye([],a.errorHandler)(d,()=>o.handler(d,i))).res,n[Xt]=o.handler),v(s=r,T,V).call(s,o.method,o.path,n)}),this}basePath(t){const a=v(this,T,vt).call(this);return a._basePath=oe(this._basePath,t),a}mount(t,a,r){let o,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?o=i=>i:o=r.replaceRequest));const s=n?i=>{const c=n(i);return Array.isArray(c)?c:[c]}:i=>{let c;try{c=i.executionCtx}catch{}return[i.env,c]};o||(o=(()=>{const i=oe(this._basePath,t),c=i==="/"?0:i.length;return u=>{const g=new URL(u.url);return g.pathname=g.pathname.slice(c)||"/",new Request(g,u)}})());const d=async(i,c)=>{const u=await a(o(i.req.raw),...s(i));if(u)return u;await c()};return v(this,T,V).call(this,I,oe(t,"*"),d),this}},B=new WeakMap,T=new WeakSet,vt=function(){const t=new ue({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,h(t,D,l(this,D)),t.routes=this.routes,t},D=new WeakMap,V=function(t,a,r){t=t.toUpperCase(),a=oe(this._basePath,a);const o={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,o]),this.routes.push(o)},Se=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},Re=function(t,a,r,o){if(o==="HEAD")return(async()=>new Response(null,await v(this,T,Re).call(this,t,a,r,"GET")))();const n=this.getPath(t,{env:r}),s=this.router.match(o,n),d=new Vt(t,{path:n,matchResult:s,env:r,executionCtx:a,notFoundHandler:l(this,D)});if(s[0].length===1){let c;try{c=s[0][0][0][0](d,async()=>{d.res=await l(this,D).call(this,d)})}catch(u){return v(this,T,Se).call(this,u,d)}return c instanceof Promise?c.then(u=>u||(d.finalized?d.res:l(this,D).call(this,d))).catch(u=>v(this,T,Se).call(this,u,d)):c??l(this,D).call(this,d)}const i=Ye(s[0],this.errorHandler,l(this,D));return(async()=>{try{const c=await i(d);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return v(this,T,Se).call(this,c,d)}})()},ue),yt=[];function ta(e,t){const a=this.buildAllMatchers(),r=(o,n)=>{const s=a[o]||a[I],d=s[2][n];if(d)return d;const i=n.match(s[0]);if(!i)return[[],yt];const c=i.indexOf("",1);return[s[1][c],i]};return this.match=r,r(e,t)}var Be="[^/]+",pe=".*",be="(?:|/.*)",se=Symbol(),aa=new Set(".\\+*[^]$()");function ra(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===pe||e===be?1:t===pe||t===be?-1:e===Be?1:t===Be?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var X,Q,A,ae,oa=(ae=class{constructor(){p(this,X);p(this,Q);p(this,A,Object.create(null))}insert(t,a,r,o,n){if(t.length===0){if(l(this,X)!==void 0)throw se;if(n)return;h(this,X,a);return}const[s,...d]=t,i=s==="*"?d.length===0?["","",pe]:["","",Be]:s==="/*"?["","",be]:s.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(i){const u=i[1];let g=i[2]||Be;if(u&&i[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw se;if(c=l(this,A)[g],!c){if(Object.keys(l(this,A)).some(f=>f!==pe&&f!==be))throw se;if(n)return;c=l(this,A)[g]=new ae,u!==""&&h(c,Q,o.varIndex++)}!n&&u!==""&&r.push([u,l(c,Q)])}else if(c=l(this,A)[s],!c){if(Object.keys(l(this,A)).some(u=>u.length>1&&u!==pe&&u!==be))throw se;if(n)return;c=l(this,A)[s]=new ae}c.insert(d,a,r,o,n)}buildRegExpStr(){const a=Object.keys(l(this,A)).sort(ra).map(r=>{const o=l(this,A)[r];return(typeof l(o,Q)=="number"?`(${r})@${l(o,Q)}`:aa.has(r)?`\\${r}`:r)+o.buildRegExpStr()});return typeof l(this,X)=="number"&&a.unshift(`#${l(this,X)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},X=new WeakMap,Q=new WeakMap,A=new WeakMap,ae),He,Te,ot,na=(ot=class{constructor(){p(this,He,{varIndex:0});p(this,Te,new oa)}insert(e,t,a){const r=[],o=[];for(let s=0;;){let d=!1;if(e=e.replace(/\{[^}]+\}/g,i=>{const c=`@\\${s}`;return o[s]=[c,i],s++,d=!0,c}),!d)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let s=o.length-1;s>=0;s--){const[d]=o[s];for(let i=n.length-1;i>=0;i--)if(n[i].indexOf(d)!==-1){n[i]=n[i].replace(d,o[s][1]);break}}return l(this,Te).insert(n,t,r,l(this,He),a),r}buildRegExp(){let e=l(this,Te).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(o,n,s)=>n!==void 0?(a[++t]=Number(n),"$()"):(s!==void 0&&(r[Number(s)]=++t),"")),[new RegExp(`^${e}`),a,r]}},He=new WeakMap,Te=new WeakMap,ot),sa=[/^$/,[],Object.create(null)],Le=Object.create(null);function wt(e){return Le[e]??(Le[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function ia(){Le=Object.create(null)}function la(e){var c;const t=new na,a=[];if(e.length===0)return sa;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,g],[f,b])=>u?1:f?-1:g.length-b.length),o=Object.create(null);for(let u=0,g=-1,f=r.length;u<f;u++){const[b,C,L]=r[u];b?o[C]=[L.map(([w])=>[w,Object.create(null)]),yt]:g++;let x;try{x=t.insert(C,g,b)}catch(w){throw w===se?new xt(C):w}b||(a[g]=L.map(([w,z])=>{const Ee=Object.create(null);for(z-=1;z>=0;z--){const[Ce,H]=x[z];Ee[Ce]=H}return[w,Ee]}))}const[n,s,d]=t.buildRegExp();for(let u=0,g=a.length;u<g;u++)for(let f=0,b=a[u].length;f<b;f++){const C=(c=a[u][f])==null?void 0:c[1];if(!C)continue;const L=Object.keys(C);for(let x=0,w=L.length;x<w;x++)C[L[x]]=d[C[L[x]]]}const i=[];for(const u in s)i[u]=a[s[u]];return[n,i,o]}function re(e,t){if(e){for(const a of Object.keys(e).sort((r,o)=>o.length-r.length))if(wt(a).test(t))return[...e[a]]}}var W,q,Pe,It,nt,ca=(nt=class{constructor(){p(this,Pe);m(this,"name","RegExpRouter");p(this,W);p(this,q);m(this,"match",ta);h(this,W,{[I]:Object.create(null)}),h(this,q,{[I]:Object.create(null)})}add(e,t,a){var d;const r=l(this,W),o=l(this,q);if(!r||!o)throw new Error(bt);r[e]||[r,o].forEach(i=>{i[e]=Object.create(null),Object.keys(i[I]).forEach(c=>{i[e][c]=[...i[I][c]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const i=wt(t);e===I?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=re(r[c],t)||re(r[I],t)||[])}):(d=r[e])[t]||(d[t]=re(r[e],t)||re(r[I],t)||[]),Object.keys(r).forEach(c=>{(e===I||e===c)&&Object.keys(r[c]).forEach(u=>{i.test(u)&&r[c][u].push([a,n])})}),Object.keys(o).forEach(c=>{(e===I||e===c)&&Object.keys(o[c]).forEach(u=>i.test(u)&&o[c][u].push([a,n]))});return}const s=dt(t)||[t];for(let i=0,c=s.length;i<c;i++){const u=s[i];Object.keys(o).forEach(g=>{var f;(e===I||e===g)&&((f=o[g])[u]||(f[u]=[...re(r[g],u)||re(r[I],u)||[]]),o[g][u].push([a,n-c+i+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(l(this,q)).concat(Object.keys(l(this,W))).forEach(t=>{e[t]||(e[t]=v(this,Pe,It).call(this,t))}),h(this,W,h(this,q,void 0)),ia(),e}},W=new WeakMap,q=new WeakMap,Pe=new WeakSet,It=function(e){const t=[];let a=e===I;return[l(this,W),l(this,q)].forEach(r=>{const o=r[e]?Object.keys(r[e]).map(n=>[n,r[e][n]]):[];o.length!==0?(a||(a=!0),t.push(...o)):e!==I&&t.push(...Object.keys(r[I]).map(n=>[n,r[I][n]]))}),a?la(t):null},nt),Z,N,st,da=(st=class{constructor(e){m(this,"name","SmartRouter");p(this,Z,[]);p(this,N,[]);h(this,Z,e.routers)}add(e,t,a){if(!l(this,N))throw new Error(bt);l(this,N).push([e,t,a])}match(e,t){if(!l(this,N))throw new Error("Fatal error");const a=l(this,Z),r=l(this,N),o=a.length;let n=0,s;for(;n<o;n++){const d=a[n];try{for(let i=0,c=r.length;i<c;i++)d.add(...r[i]);s=d.match(e,t)}catch(i){if(i instanceof xt)continue;throw i}this.match=d.match.bind(d),h(this,Z,[d]),h(this,N,void 0);break}if(n===o)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,s}get activeRouter(){if(l(this,N)||l(this,Z).length!==1)throw new Error("No active router has been determined yet.");return l(this,Z)[0]}},Z=new WeakMap,N=new WeakMap,st),fe=Object.create(null),K,k,ee,ge,E,j,Y,he,ua=(he=class{constructor(t,a,r){p(this,j);p(this,K);p(this,k);p(this,ee);p(this,ge,0);p(this,E,fe);if(h(this,k,r||Object.create(null)),h(this,K,[]),t&&a){const o=Object.create(null);o[t]={handler:a,possibleKeys:[],score:0},h(this,K,[o])}h(this,ee,[])}insert(t,a,r){h(this,ge,++Ve(this,ge)._);let o=this;const n=Mt(a),s=[];for(let d=0,i=n.length;d<i;d++){const c=n[d],u=n[d+1],g=$t(c,u),f=Array.isArray(g)?g[0]:c;if(f in l(o,k)){o=l(o,k)[f],g&&s.push(g[1]);continue}l(o,k)[f]=new he,g&&(l(o,ee).push(g),s.push(g[1])),o=l(o,k)[f]}return l(o,K).push({[t]:{handler:r,possibleKeys:s.filter((d,i,c)=>c.indexOf(d)===i),score:l(this,ge)}}),o}search(t,a){var i;const r=[];h(this,E,fe);let n=[this];const s=lt(a),d=[];for(let c=0,u=s.length;c<u;c++){const g=s[c],f=c===u-1,b=[];for(let C=0,L=n.length;C<L;C++){const x=n[C],w=l(x,k)[g];w&&(h(w,E,l(x,E)),f?(l(w,k)["*"]&&r.push(...v(this,j,Y).call(this,l(w,k)["*"],t,l(x,E))),r.push(...v(this,j,Y).call(this,w,t,l(x,E)))):b.push(w));for(let z=0,Ee=l(x,ee).length;z<Ee;z++){const Ce=l(x,ee)[z],H=l(x,E)===fe?{}:{...l(x,E)};if(Ce==="*"){const $=l(x,k)["*"];$&&(r.push(...v(this,j,Y).call(this,$,t,l(x,E))),h($,E,H),b.push($));continue}const[Lt,Ze,me]=Ce;if(!g&&!(me instanceof RegExp))continue;const P=l(x,k)[Lt],Bt=s.slice(c).join("/");if(me instanceof RegExp){const $=me.exec(Bt);if($){if(H[Ze]=$[0],r.push(...v(this,j,Y).call(this,P,t,l(x,E),H)),Object.keys(l(P,k)).length){h(P,E,H);const Ue=((i=$[0].match(/\//))==null?void 0:i.length)??0;(d[Ue]||(d[Ue]=[])).push(P)}continue}}(me===!0||me.test(g))&&(H[Ze]=g,f?(r.push(...v(this,j,Y).call(this,P,t,H,l(x,E))),l(P,k)["*"]&&r.push(...v(this,j,Y).call(this,l(P,k)["*"],t,H,l(x,E)))):(h(P,E,H),b.push(P)))}}n=b.concat(d.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},K=new WeakMap,k=new WeakMap,ee=new WeakMap,ge=new WeakMap,E=new WeakMap,j=new WeakSet,Y=function(t,a,r,o){const n=[];for(let s=0,d=l(t,K).length;s<d;s++){const i=l(t,K)[s],c=i[a]||i[I],u={};if(c!==void 0&&(c.params=Object.create(null),n.push(c),r!==fe||o&&o!==fe))for(let g=0,f=c.possibleKeys.length;g<f;g++){const b=c.possibleKeys[g],C=u[c.score];c.params[b]=o!=null&&o[b]&&!C?o[b]:r[b]??(o==null?void 0:o[b]),u[c.score]=!0}}return n},he),te,it,ga=(it=class{constructor(){m(this,"name","TrieRouter");p(this,te);h(this,te,new ua)}add(e,t,a){const r=dt(t);if(r){for(let o=0,n=r.length;o<n;o++)l(this,te).insert(e,r[o],a);return}l(this,te).insert(e,t,a)}match(e,t){return l(this,te).search(e,t)}},te=new WeakMap,it),Tt=class extends ea{constructor(e={}){super(e),this.router=e.router??new da({routers:[new ca,new ga]})}},ha=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(n=>typeof n=="string"?n==="*"?()=>n:s=>n===s?s:null:typeof n=="function"?n:s=>n.includes(s)?s:null)(a.origin),o=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(a.allowMethods);return async function(s,d){var u;function i(g,f){s.res.headers.set(g,f)}const c=await r(s.req.header("origin")||"",s);if(c&&i("Access-Control-Allow-Origin",c),a.credentials&&i("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&i("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),s.req.method==="OPTIONS"){a.origin!=="*"&&i("Vary","Origin"),a.maxAge!=null&&i("Access-Control-Max-Age",a.maxAge.toString());const g=await o(s.req.header("origin")||"",s);g.length&&i("Access-Control-Allow-Methods",g.join(","));let f=a.allowHeaders;if(!(f!=null&&f.length)){const b=s.req.header("Access-Control-Request-Headers");b&&(f=b.split(/\s*,\s*/))}return f!=null&&f.length&&(i("Access-Control-Allow-Headers",f.join(",")),s.res.headers.append("Vary","Access-Control-Request-Headers")),s.res.headers.delete("Content-Length"),s.res.headers.delete("Content-Type"),new Response(null,{headers:s.res.headers,status:204,statusText:"No Content"})}await d(),a.origin!=="*"&&s.header("Vary","Origin",{append:!0})}},De={};const y=new Tt,ma=5*60*1e3,_e=new Map;function Et(e){const t=_e.get(e);return t?t.data:null}function Ct(e,t,a){_e.set(e,{data:t,timestamp:Date.now(),etag:a})}function kt(e){const t=_e.get(e);return t?Date.now()-t.timestamp<ma:!1}const Fe=3,Qe=1e3;async function Ae(e,t,a=Fe){try{const r=await fetch(e,t);if(r.status===429&&a>0){const o=Qe*(Fe-a+1);return console.log(`Rate limited (429). Retrying in ${o}ms... (${a} retries left)`),await new Promise(n=>setTimeout(n,o)),Ae(e,t,a-1)}return r}catch(r){if(a>0){const o=Qe*(Fe-a+1);return console.log(`Fetch failed. Retrying in ${o}ms... (${a} retries left)`),await new Promise(n=>setTimeout(n,o)),Ae(e,t,a-1)}throw r}}y.use("/api/*",ha());const F=typeof process<"u"&&De&&De.NOCODB_BASE_URL||"http://31.220.49.162:8080",We=typeof process<"u"&&De&&De.KIEAI_API_KEY||"cf2a50987a92a698e89d5efeb80cde82",ze={face:"https://iili.io/fM9hV6B.png",outfit:"https://iili.io/fM99P3l.png",logo:"https://iili.io/fEiEfUB.png"};y.get("/api/bases",async e=>{const t=e.req.header("xc-token")||e.env.NOCODB_TOKEN;if(!t)return e.json({error:"Missing NocoDB token"},401);const a=`bases:${t.substring(0,10)}`,r=Et(a),o=kt(a);if(r&&o)return console.log("Returning cached bases data"),e.json(r);try{const n=F+"/api/v2/meta/bases",s=await Ae(n,{headers:{"xc-token":t}});if(!s.ok){const g=await s.text();if(console.error("NocoDB API error:",s.status,g),r)return console.log("Returning stale cached data due to API error"),e.json({...r,_cached:!0,_cacheStale:!0,_error:`NocoDB API error: ${s.status}. Showing cached data.`});let f=`NocoDB API error: ${s.status}`;return s.status===429?f="NocoDB rate limit exceeded. Please wait a moment and try again.":(s.status===401||s.status===403)&&(f="Invalid or expired NocoDB token. Please check your token and try again."),e.json({error:f,details:g},s.status)}const d=await s.json();let i=d.list||d.bases||[];Array.isArray(i)||(i=[]);const u={bases:i.map(g=>({id:g.id,name:g.title||g.name||"Unnamed Base"}))};return Ct(a,u),console.log(`Total bases fetched and cached: ${i.length}`),e.json(u)}catch(n){return console.error("Error fetching bases:",n),r?(console.log("Returning stale cached data due to error"),e.json({...r,_cached:!0,_cacheStale:!0,_error:`Network error: ${n.message}. Showing cached data.`})):e.json({error:n.message||"Failed to fetch bases"},500)}});y.get("/api/bases/:baseId/tables",async e=>{const t=e.req.header("xc-token")||e.env.NOCODB_TOKEN;if(!t)return e.json({error:"Missing NocoDB token"},401);const a=e.req.param("baseId"),r=`tables:${a}:${t.substring(0,10)}`,o=Et(r),n=kt(r);if(o&&n)return console.log(`Returning cached tables for base ${a}`),e.json(o);console.log(`Fetching tables for base: ${a}, token present: ${t?"yes":"no"}, token prefix: ${t.substring(0,10)}...`);try{const s=await Ae(F+`/api/v2/meta/bases/${a}/tables`,{headers:{"xc-token":t}});if(!s.ok){const u=await s.text();if(console.error("NocoDB tables API error:",s.status,u),o)return console.log("Returning stale cached tables due to API error"),e.json({...o,_cached:!0,_cacheStale:!0,_error:`NocoDB API error: ${s.status}. Showing cached data.`});let g=`NocoDB API error: ${s.status}`;return s.status===429?g="NocoDB rate limit exceeded. Please wait a moment and try again.":s.status===401||s.status===403?g="Invalid or expired NocoDB token. Please check your token and try again.":s.status===404&&(g="Base not found. Please check if you have access to this base."),e.json({error:g,details:u},s.status)}const c={tables:((await s.json()).list||[]).map(u=>({id:u.id,name:u.title||u.table_name||u.name||"Unnamed Table",fields:u.columns||u.fields||[]}))};return Ct(r,c),console.log(`Fetched and cached ${c.tables.length} tables for base ${a}`),e.json(c)}catch(s){return console.error("Error fetching tables:",s),o?(console.log("Returning stale cached tables due to error"),e.json({...o,_cached:!0,_cacheStale:!0,_error:`Network error: ${s.message}. Showing cached data.`})):e.json({error:s.message||"Failed to fetch tables"},500)}});y.get("/api/records",async e=>{var s,d;const t=e.req.header("xc-token")||e.env.NOCODB_TOKEN;if(!t)return e.json({error:"Missing NocoDB token"},401);const a=e.req.query("tableId");if(e.req.query("filter"),!a)return e.json({error:"Missing tableId"},400);let r=F+`/api/v2/tables/${a}/records`;const n=await(await fetch(r,{headers:{"xc-token":t}})).json();return n.list&&Array.isArray(n.list)?e.json({records:n.list.map(i=>({id:i.Id||i.id,fields:i})),offset:(s=n.pageInfo)!=null&&s.isLastPage?null:((d=n.pageInfo)==null?void 0:d.page)+1}):e.json(n)});y.get("/api/records/:id",async e=>{const t=e.req.header("xc-token")||e.env.NOCODB_TOKEN;if(!t)return e.json({error:"Missing NocoDB token"},401);const a=e.req.query("tableId"),r=e.req.param("id");if(!a)return e.json({error:"Missing tableId"},400);const n=await(await fetch(F+`/api/v2/tables/${a}/records/${r}`,{headers:{"xc-token":t}})).json();return n&&!n.error?e.json({id:n.Id||n.id,fields:n}):e.json(n)});y.patch("/api/records/:id",async e=>{const t=e.req.header("xc-token")||e.env.NOCODB_TOKEN;if(!t)return e.json({error:"Missing NocoDB token"},401);const a=e.req.query("tableId"),r=e.req.param("id"),o=await e.req.json();if(!a)return e.json({error:"Missing tableId"},400);const n={Id:r,...o},d=await(await fetch(F+`/api/v2/tables/${a}/records`,{method:"PATCH",headers:{"xc-token":t,"Content-Type":"application/json"},body:JSON.stringify(n)})).json();return d&&!d.error?e.json({id:d.Id||r,fields:d}):e.json(d)});y.post("/api/generate-image",async e=>{const{prompt:t,imageUrls:a,aspectRatio:r}=await e.req.json(),o={model:"google/nano-banana",input:{prompt:t,image_urls:a||[ze.face,ze.outfit,ze.logo],image_size:r||"16:9",output_format:"png"}};console.log("KieAI Nano Banana Request:",JSON.stringify(o,null,2));const n=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${We}`,"Content-Type":"application/json"},body:JSON.stringify(o)});return e.json(await n.json())});const et={"16:9":"https://iili.io/fk9ypqB.png","9:16":"https://iili.io/fk9yy0P.png","1:1":"https://iili.io/fkH99g1.png"};y.post("/api/generate-image-ideogram",async e=>{const{prompt:t,imageUrl:a,aspectRatio:r}=await e.req.json(),o=et[r]||et["16:9"],n={model:"ideogram/character-edit",input:{prompt:t,image_url:a,mask_url:o,rendering_speed:"BALANCED",style:"AUTO",expand_prompt:!1,num_images:"1"}};console.log("Ideogram character-edit Request (text overlay):",JSON.stringify(n,null,2));const s=await fetch("https://api.kie.ai/api/v1/jobs/createTask",{method:"POST",headers:{Authorization:`Bearer ${We}`,"Content-Type":"application/json"},body:JSON.stringify(n)});return e.json(await s.json())});y.get("/api/task-status/:taskId",async e=>{const t=e.req.param("taskId"),a=await fetch(`https://api.kie.ai/api/v1/jobs/recordInfo?taskId=${t}`,{headers:{Authorization:`Bearer ${We}`}});return e.json(await a.json())});y.post("/api/upload-image",async e=>{const{base64Image:t}=await e.req.json(),a=new FormData;a.append("key","6d207e02198a847aa98d0a2a901485a5"),a.append("action","upload"),a.append("source",t),a.append("format","json");const r=await fetch("https://freeimage.host/api/1/upload",{method:"POST",body:a});return e.json(await r.json())});y.post("/api/proxy-image",async e=>{try{const{imageUrl:t}=await e.req.json();if(!t)return e.json({error:"Missing imageUrl"},400);const a=await fetch(t);if(!a.ok)return e.json({error:"Failed to fetch image: "+a.status},500);const r=await a.arrayBuffer(),o=new Uint8Array(r);let n="";for(let i=0;i<o.length;i++)n+=String.fromCharCode(o[i]);const s=btoa(n),d=a.headers.get("content-type")||"image/png";return e.json({success:!0,base64:s,contentType:d,dataUrl:"data:"+d+";base64,"+s})}catch(t){return e.json({error:"Proxy error: "+t.message},500)}});y.get("/api/nocodb-proxy/*",async e=>{const t=e.req.header("xc-token")||e.env.NOCODB_TOKEN,a=e.req.path.replace("/api/nocodb-proxy/","");if(!a)return e.json({error:"Missing path"},400);const r=F+"/"+a;try{const o={};t&&(o["xc-token"]=t);const n=await fetch(r,{headers:o});if(!n.ok)return e.json({error:"Failed to fetch from NocoDB: "+n.status},n.status);const s=await n.arrayBuffer(),d=n.headers.get("content-type")||"application/octet-stream";return new Response(s,{headers:{"Content-Type":d,"Cache-Control":"public, max-age=3600"}})}catch(o){return e.json({error:"Proxy error: "+o.message},500)}});const qe={crypto:{baseId:"prs1ubx2662cbv6",tableId:"m5fb56hy2px2fuv",fieldMap:{url:"URL",title:"Title",notes:"Summary",platforms:"Platforms",status:"Status",statusValue:"Needs Review"}},ai:{baseId:"prs1ubx2662cbv6",tableId:"m5fb56hy2px2fuv",fieldMap:{url:"URL",title:"Title",notes:"Summary",platforms:"Platforms",status:"Status",statusValue:"Needs Review"}},general:{baseId:"prs1ubx2662cbv6",tableId:"m5fb56hy2px2fuv",fieldMap:{url:"URL",title:"Title",notes:"Summary",platforms:"Platforms",status:"Status",statusValue:"Needs Review"}}},fa=["Twitter","LinkedIn","Blog","Instagram","Facebook","Avatar"],Oe="htjKEaVOkCm8QoJgzxYQ4iA1SL8SX_ZRQbVSSi_7",pa={crypto:"https://fifthaveai.app.n8n.cloud/webhook/crypto-pickup",ai:"https://fifthaveai.app.n8n.cloud/webhook/ai-pickup"};async function St(e,t,a){const r=pa[e];if(r)try{await new Promise(n=>setTimeout(n,2e3)),console.log(`[Instant Pickup] Triggering ${e} webhook for record ${t}`);const o=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({recordId:t,sourceURL:a.sourceURL,sourceHeadline:a.sourceHeadline,sourceSummary:a.sourceSummary,topic:e,triggeredAt:new Date().toISOString()})});console.log(`[Instant Pickup] Webhook response: ${o.status}`)}catch(o){console.error("[Instant Pickup] Webhook error:",o.message)}}y.post("/api/save",async e=>{var t;try{const{url:a,title:r,notes:o,platforms:n,topic:s}=await e.req.json();if(!a)return e.json({success:!1,error:"URL is required"},400);const d=((t=e.env)==null?void 0:t.NOCODB_TOKEN)||Oe,i=s||"general",c=qe[i];if(!c)return e.json({success:!1,error:"Invalid topic. Use: crypto, ai, or general"},400);const u=c.fieldMap,g={};if(g[u.url]=a,g[u.title]=r||"",g[u.status]=u.statusValue,o&&(g[u.notes]=o),n&&n.length>0)if(i==="crypto"||i==="ai"){const x=n.filter(w=>fa.includes(w));x.length>0&&(g[u.platforms]=x)}else g[u.platforms]=n;i==="general"&&(g["Created Date"]=new Date().toISOString());const b=await(await fetch(`${F}/api/v2/tables/${c.tableId}/records`,{method:"POST",headers:{"xc-token":d,"Content-Type":"application/json"},body:JSON.stringify(g)})).json();if(b.error){console.error("NocoDB error:",b.error);const x=typeof b.error=="string"?b.error:b.error.message||"NocoDB error";return e.json({success:!1,error:x},500)}const C={id:b.Id,fields:b};let L=!1;if((i==="crypto"||i==="ai")&&b.id){L=!0;const x=St(i,b.id,{sourceURL:a,sourceHeadline:r||"",sourceSummary:o||""});e.executionCtx&&typeof e.executionCtx.waitUntil=="function"?e.executionCtx.waitUntil(x):x.catch(w=>console.error("[Instant Pickup] Background error:",w))}return e.json({success:!0,record:C,topic:i,table:i==="general"?"Content Pipeline":i==="crypto"?"Social Posts":"Social Posts - AI",processing:L?"started":"not_applicable"})}catch(a){return console.error("Save error:",a),e.json({success:!1,error:a.message||"Server error"},500)}});y.get("/api/process-status/:recordId",async e=>{var t;try{const a=e.req.param("recordId"),r=e.req.query("topic")||"crypto",o=qe[r];if(!o)return e.json({error:"Invalid topic"},400);const n=((t=e.env)==null?void 0:t.NOCODB_TOKEN)||Oe,i=await(await fetch(`${F}/api/v2/tables/${o.tableId}/records/${a}`,{headers:{"xc-token":n}})).json()||{},c=!!(i.sourceSummary&&i.sourceSummary.length>50),u=!!(i.imagePrompt&&i.imagePrompt.length>10),g=!!(i["Twitter Copy"]&&i["Twitter Copy"].length>5);let f="processing";return c&&u&&g?f="complete":c&&(f="generating_content"),e.json({recordId:a,status:f,fields:{hasResearch:c,hasImagePrompt:u,hasSocialContent:g,rewrittenHeadline:i.rewrittenHeadline||null}})}catch(a){return e.json({error:a.message},500)}});y.post("/api/process",async e=>{var t;try{const{recordId:a,topic:r}=await e.req.json();if(!a||!r)return e.json({error:"recordId and topic are required"},400);if(r==="general")return e.json({error:"Processing only available for crypto/ai topics"},400);const o=qe[r];if(!o)return e.json({error:"Invalid topic"},400);const n=((t=e.env)==null?void 0:t.NOCODB_TOKEN)||Oe,i=await(await fetch(`${F}/api/v2/tables/${o.tableId}/records/${a}`,{headers:{"xc-token":n}})).json()||{};return await St(r,a,{sourceURL:i.sourceURL||"",sourceHeadline:i.sourceHeadline||"",sourceSummary:i.sourceSummary||""}),e.json({success:!0,status:"processing_started",recordId:a})}catch(a){return e.json({error:a.message},500)}});y.get("/api/topics",e=>e.json({topics:[{id:"crypto",label:"🪙 Crypto News",description:"Save to 5th Ave Crypto pipeline"},{id:"ai",label:"🤖 AI News",description:"Save to 5th Ave AI pipeline"},{id:"general",label:"📋 General Pipeline",description:"Save to Content Pipeline"}]}));y.get("/",e=>e.html(`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body class="text-gray-100">
  ...
  <script>
    ...
    // CONFIGURATION
    // ========================================
    const NOCODB_TOKEN = '${(e.env||{}).NOCODB_TOKEN||Oe}';
  ...
  `));y.get("/favicon.ico",e=>e.body(null,204));y.all("*",e=>e.json({error:"Not found"},404));const tt=new Tt,ba=Object.assign({"/src/index.tsx":y});let Rt=!1;for(const[,e]of Object.entries(ba))e&&(tt.route("/",e),tt.notFound(e.notFoundHandler),Rt=!0);if(!Rt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{tt as default};
