...
Keep the original image EXACTLY as-is - only add the banner and text at the bottom. Do not modify anything else.\`;
  ...
  `));const qe=new ht,ta=Object.assign({"/src/index.tsx":k});let mt=!1;for(const[,e]of Object.entries(ta))e&&(qe.route("/",e),qe.notFound(e.notFoundHandler),mt=!0);if(!mt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{qe as default};
