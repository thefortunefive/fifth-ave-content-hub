...
// .wrangler/tmp/pages-5Yo7Ah/bundledWorker-0.21397922453509222.mjs
...
var m = /* @__PURE__ */ __name2((e, t, a) => vt(e, typeof t != "symbol" ? t + "" : t, a), "m");
...
var Ht = at;
var Dt = /* @__PURE__ */ __name2((e, t) => at(e, t, true), "Dt");
...
var Nt = (ce = class {
  ...
  route(t, a) {
    ...
    return a.routes.map((n) => {
      var i;
      let o;
      a.errorHandler === qe ? o = n.handler : (o = /* @__PURE__ */ __name2(async (c, l) => (await Ge([], a.errorHandler)(c, () => n.handler(c, l))).res, "o"), o[Mt] = n.handler), b(i = r, w, Y).call(i, n.method, n.path, o);
    }), this;
  }
  basePath(t) {
...
function Jt(e) {
  ...
  for (let u = 0, g = -1, p = r.length; u < p; u++) {
    const [v, C, M] = r[u];
    v ? n[C] = [M.map(([E]) => [E, /* @__PURE__ */ Object.create(null)]), ut] : g++;
    let x;
    try {
      x = t.insert(C, g, v);
    } catch (E) {
...
}, _ = /* @__PURE__ */ new WeakMap(), q = /* @__PURE__ */ new WeakMap(), Be = /* @__PURE__ */ new WeakSet(), ft = /* @__PURE__ */ __name2(function(e) {
  const t = [];
  let a = e === y;
    ...
    for (let d = 0, u = i.length; d < u; d++) {
      ...
      for (let C = 0, M = o.length; C < M; C++) {
        ...
        for (let U = 0, Te = s(x, Q).length; U < Te; U++) {
          const Ee = s(x, Q)[U], H = s(x, I) === me ? {} : { ...s(x, I) };
          if (Ee === "*") {
            const N = s(x, T)["*"];
          ...
          if (fe instanceof RegExp) {
            const N = fe.exec(bt);
            if (N) {
              if (H[Ue] = N[0], r.push(...b(this, j, J).call(this, D, t, s(x, I), H)), Object.keys(s(D, T)).length) {
                f(D, I, H);
          ...
          (fe === true || fe.test(g)) && (H[Ue] = g, p ? (r.push(...b(this, j, J).call(this, D, t, H, s(x, I))), s(D, T)["*"] && r.push(...b(this, j, J).call(this, s(D, T)["*"], t, H, s(x, I)))) : (f(D, I, H), v.push(D)));
        }
      }
      o = v.concat(c.shift() ?? []);
    }
...
var ht = false;
for (const [, e] of Object.entries(ta)) e && (Ze.route("/", e), Ze.notFound(e.notFoundHandler), ht = true);
...
// .wrangler/tmp/pages-5Yo7Ah/55v9130awna.js
...
// .wrangler/tmp/bundle-YgXYl4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-YgXYl4/middleware-loader.entry.ts
